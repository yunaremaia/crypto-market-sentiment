...
function paymentMiddleware(payTo, routes, facilitator, paywall) {
  ...
  return async function paymentMiddleware2(c, next) {
    ...
    try {
      ...
      return c.json(
        {
          error: (errorMessages == null ? void 0 : errorMessages.invalidPayment) || (error instanceof Error ? error.message : "Invalid or malformed payment header"),
          accepts: paymentRequirements,
          x402Version
        },
        402
    ...
    try {
      ...
      return c.json(
        {
          error: (errorMessages == null ? void 0 : errorMessages.verificationFailed) || (error instanceof Error ? error.message : "Payment verification failed"),
          accepts: paymentRequirements,
          x402Version
        },
        402
    ...
    try {
      ...
      res = c.json(
        {
          error: (errorMessages == null ? void 0 : errorMessages.settlementFailed) || (error instanceof Error ? error.message : "Failed to settle payment"),
          accepts: paymentRequirements,
          x402Version
        },
        402
