 ...
 */
export function fromCdpEvmAccount(account) {
 ...
 */
export function resolveNetworkFromChainId(chainId) {
 ...
 * @returns A `ClientEvmSigner` compatible with `@x402/evm`'s `registerExactEvmScheme`
 */
export function fromCdpSmartWallet(account) {
    const signerShape = {
 ...
 */
export function cdpSolanaAccountToSvmSigner(account) {
