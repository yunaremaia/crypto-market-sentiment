...
export async function getAuthHeaders(options) {
    ...
    if (!hasCredentials && !isPublicOperation(options.requestMethod, options.requestPath)) {
        throw new UserInputValidationError("Missing required CDP API Key configuration. Please set the CDP_API_KEY_ID and CDP_API_KEY_SECRET environment variables, or pass them as options to the CdpClient constructor.");
    }
    /*
