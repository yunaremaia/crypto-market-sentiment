...
export class PaymentMethodsClient {
     ...
     *
     * @param {CoinbaseApi.ListPaymentMethodsRequest} request
    ...
    public listPaymentMethods(
        request: CoinbaseApi.ListPaymentMethodsRequest = {},
        requestOptions?: PaymentMethodsClient.RequestOptions,
    ): core.HttpResponsePromise<CoinbaseApi.ListPaymentMethodsResponse> {
    ...
    private async __listPaymentMethods(
        request: CoinbaseApi.ListPaymentMethodsRequest = {},
        requestOptions?: PaymentMethodsClient.RequestOptions,
    ): Promise<core.WithRawResponse<CoinbaseApi.ListPaymentMethodsResponse>> {
        const _metadata: core.EndpointMetadata = {
            security: [{ apiKeyAuth: [] }],
            method: "GET",
            path: "v2/payment-methods",
            operationId: "endpoint_paymentMethods.listPaymentMethods",
        };
        ...
        if (_response.ok) {
            return {
                data: _response.body as CoinbaseApi.ListPaymentMethodsResponse,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/payment-methods");
    }
     ...
     *
     * @param {CoinbaseApi.GetPaymentMethodRequest} request
     * @param {PaymentMethodsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws CoinbaseApi.BadRequestError
     * @throws CoinbaseApi.UnauthorizedError
    ...
    public getPaymentMethod(
        request: CoinbaseApi.GetPaymentMethodRequest,
        requestOptions?: PaymentMethodsClient.RequestOptions,
    ): core.HttpResponsePromise<CoinbaseApi.PaymentMethodsPaymentMethod> {
        return core.HttpResponsePromise.fromPromise(this.__getPaymentMethod(request, requestOptions));
    }

    private async __getPaymentMethod(
        request: CoinbaseApi.GetPaymentMethodRequest,
        requestOptions?: PaymentMethodsClient.RequestOptions,
    ): Promise<core.WithRawResponse<CoinbaseApi.PaymentMethodsPaymentMethod>> {
        const _metadata: core.EndpointMetadata = {
            security: [{ apiKeyAuth: [] }],
            method: "GET",
            path: "v2/payment-methods/{paymentMethodId}",
            operationId: "endpoint_paymentMethods.getPaymentMethod",
        };
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.CoinbaseApiEnvironment.Default,
                `v2/payment-methods/${core.url.encodePathParam(paymentMethodId)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as CoinbaseApi.PaymentMethodsPaymentMethod,
                rawResponse: _response.rawResponse,
            };
        }
