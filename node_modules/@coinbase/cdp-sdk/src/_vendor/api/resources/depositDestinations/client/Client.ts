...
export declare namespace DepositDestinationsClient {
...
export class DepositDestinationsClient {
    ...
    constructor(options: DepositDestinationsClient.Options) {
     ...
     * ```
     */
    public listDepositDestinations(
        request: CoinbaseApi.ListDepositDestinationsRequest = {},
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): core.HttpResponsePromise<CoinbaseApi.ListDepositDestinationsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listDepositDestinations(request, requestOptions));
    }

    private async __listDepositDestinations(
        request: CoinbaseApi.ListDepositDestinationsRequest = {},
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<CoinbaseApi.ListDepositDestinationsResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as CoinbaseApi.ListDepositDestinationsResponse,
     ...
     * ```
     */
    public createDepositDestination(
        request: CoinbaseApi.CreateDepositDestinationBody,
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): core.HttpResponsePromise<CoinbaseApi.DepositDestination> {
        return core.HttpResponsePromise.fromPromise(this.__createDepositDestination(request, requestOptions));
    }

    private async __createDepositDestination(
        request: CoinbaseApi.CreateDepositDestinationBody,
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<CoinbaseApi.DepositDestination>> {
        const _metadata: core.EndpointMetadata = {
            security: [{ apiKeyAuth: [] }],
            method: "POST",
            path: "v2/deposit-destinations",
        ...
        if (_response.ok) {
            return { data: _response.body as CoinbaseApi.DepositDestination, rawResponse: _response.rawResponse };
        }
     ...
     * ```
     */
    public getDepositDestinationById(
        request: CoinbaseApi.GetDepositDestinationByIdRequest,
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): core.HttpResponsePromise<CoinbaseApi.DepositDestination> {
        return core.HttpResponsePromise.fromPromise(this.__getDepositDestinationById(request, requestOptions));
    }

    private async __getDepositDestinationById(
        request: CoinbaseApi.GetDepositDestinationByIdRequest,
        requestOptions?: DepositDestinationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<CoinbaseApi.DepositDestination>> {
        const _metadata: core.EndpointMetadata = {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.CoinbaseApiEnvironment.Default,
                `v2/deposit-destinations/${core.url.encodePathParam(depositDestinationId)}`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
