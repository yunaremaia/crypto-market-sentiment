...
exports.SPEND_CONTROLS_REGISTRY = exports.DEFAULT_APPROACHING_LIMIT_THRESHOLDS = void 0;
...
const parseAtomicFromRequirement = (req) => {
    const raw = "amount" in req && req.amount !== undefined
        ? req.amount
    ...
    if (parsed < 0n) {
        throw new types_js_1.SpendControlError("amount_unparseable", `PaymentRequirements.amount ${JSON.stringify(req.amount)} must be a non-negative atomic integer`, {
