...
exports.isOwnerAlreadyHasSmartWalletError = isOwnerAlreadyHasSmartWalletError;
exports.findSmartAccountByOwner = findSmartAccountByOwner;
/**
 ...
 */
function isOwnerAlreadyHasSmartWalletError(error) {
    return (error instanceof Error && error.message.includes("Multiple smart wallets with the same owner"));
}
/**
 ...
 */
async function findSmartAccountByOwner(cdpClient, ownerAddress) {
