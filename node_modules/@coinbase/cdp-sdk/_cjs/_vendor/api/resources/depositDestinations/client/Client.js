...
exports.DepositDestinationsClient = void 0;
 ...
 */
class DepositDestinationsClient {
    _options;
    constructor(options) {
    ...
    async __listDepositDestinations(request = {}, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v2/deposit-destinations");
    }
    /**
    ...
    async __createDepositDestination(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v2/deposit-destinations");
    }
    /**
    ...
    async __getDepositDestinationById(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v2/deposit-destinations/{depositDestinationId}");
    }
}
exports.DepositDestinationsClient = DepositDestinationsClient;
