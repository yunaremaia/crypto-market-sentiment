...
exports.TransfersClient = void 0;
...
class TransfersClient {
    ...
    async __listTransfers(request = {}, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v2/transfers");
    }
    /**
    ...
    async __createTransfer(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v2/transfers");
    }
    /**
    ...
    async __getTransferById(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v2/transfers/{transferId}");
    }
    /**
    ...
    async __executeFundTransfer(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v2/transfers/{transferId}/execute");
    }
    /**
    ...
    async __submitDepositTravelRule(request, requestOptions) {
        ...
        return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v2/transfers/{transferId}/travel-rule");
    }
}
exports.TransfersClient = TransfersClient;
