...
const signX402Payment_js_1 = require("../../actions/x402/signX402Payment.js");
...
function toEvmSmartAccount(apiClient, options) {
    const account = {
        ...
        async signX402Payment(paymentRequired, acceptedIndex) {
            ...
            try {
                return await (0, signX402Payment_js_1.signEvmSmartAccountX402Payment)(account, {
                    paymentRequired,
                    acceptedIndex,
                });
            }
            catch (error) {
                analytics_js_1.Analytics.trackError(error, "signX402Payment");
                throw error;
            }
        },
