...
async function toNetworkScopedEvmSmartAccount(apiClient, options) {
    ...
    const { chain: scopedChain } = await (0, resolveViemClients_js_1.resolveViemClients)({
    ...
    const account = {
        ...
        signX402Payment: async (paymentRequired, acceptedIndex) => {
            ...
            if (selected && selected.network !== scopedCaip2) {
                throw new Error(`acceptedIndex ${acceptedIndex} targets network "${selected.network}" but this account ` +
