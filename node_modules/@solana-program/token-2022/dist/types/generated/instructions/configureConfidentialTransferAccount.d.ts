...
export declare function getConfigureConfidentialTransferAccountDiscriminatorBytes(): ReadonlyUint8Array;
export declare const CONFIGURE_CONFIDENTIAL_TRANSFER_ACCOUNT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR = 2;
export declare function getConfigureConfidentialTransferAccountConfidentialTransferDiscriminatorBytes(): ReadonlyUint8Array;
...
export declare function getConfigureConfidentialTransferAccountInstructionDataEncoder(): FixedSizeEncoder<ConfigureConfidentialTransferAccountInstructionDataArgs>;
export declare function getConfigureConfidentialTransferAccountInstructionDataDecoder(): FixedSizeDecoder<ConfigureConfidentialTransferAccountInstructionData>;
export declare function getConfigureConfidentialTransferAccountInstructionDataCodec(): FixedSizeCodec<ConfigureConfidentialTransferAccountInstructionDataArgs, ConfigureConfidentialTransferAccountInstructionData>;
...
}): ConfigureConfidentialTransferAccountInstruction<TProgramAddress, TAccountToken, TAccountMint, TAccountInstructionsSysvarOrContextState, TAccountRecord, (typeof input)['authority'] extends TransactionSigner<TAccountAuthority> ? ReadonlySignerAccount<TAccountAuthority> & AccountSignerMeta<TAccountAuthority> : TAccountAuthority>;
export type ParsedConfigureConfidentialTransferAccountInstruction<TProgram extends string = typeof TOKEN_2022_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
