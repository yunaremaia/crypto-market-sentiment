...
export type InitializeTokenGroupMemberInstruction<TProgram extends string = typeof TOKEN_2022_PROGRAM_ADDRESS, TAccountMember extends string | AccountMeta<string> = string, TAccountMemberMint extends string | AccountMeta<string> = string, TAccountMemberMintAuthority extends string | AccountMeta<string> = string, TAccountGroup extends string | AccountMeta<string> = string, TAccountGroupUpdateAuthority extends string | AccountMeta<string> = string, TRemainingAccounts extends readonly AccountMeta<string>[] = []> = Instruction<TProgram> & InstructionWithData<ReadonlyUint8Array> & InstructionWithAccounts<[
    ...
    TAccountMemberMintAuthority extends string ? ReadonlySignerAccount<TAccountMemberMintAuthority> & AccountSignerMeta<TAccountMemberMintAuthority> : TAccountMemberMintAuthority,
...
export type ParsedInitializeTokenGroupMemberInstruction<TProgram extends string = typeof TOKEN_2022_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
