"use strict";var Pl=Object.create;var er=Object.defineProperty;var Fl=Object.getOwnPropertyDescriptor;var _l=Object.getOwnPropertyNames;var Nl=Object.getPrototypeOf,Dl=Object.prototype.hasOwnProperty;var $l=(i,e)=>{for(var t in e)er(i,t,{get:e[t],enumerable:!0})},Vs=(i,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of _l(e))!Dl.call(i,r)&&r!==t&&er(i,r,{get:()=>e[r],enumerable:!(n=Fl(e,r))||n.enumerable});return i};var gn=(i,e,t)=>(t=i!=null?Pl(Nl(i)):{},Vs(e||!i||!i.__esModule?er(t,"default",{value:i,enumerable:!0}):t,i)),Ll=i=>Vs(er({},"__esModule",{value:!0}),i);var pu={};$l(pu,{AxACE:()=>ho,AxACEOptimizedProgram:()=>Kn,AxAI:()=>Fn,AxAIAnthropic:()=>kt,AxAIAnthropicModel:()=>fn,AxAIAnthropicVertexModel:()=>An,AxAIAzureOpenAI:()=>Ft,AxAICohere:()=>_t,AxAICohereEmbedModel:()=>Tn,AxAICohereModel:()=>In,AxAIDeepSeek:()=>Nt,AxAIDeepSeekModel:()=>Cn,AxAIGoogleGemini:()=>Dt,AxAIGoogleGeminiEmbedModel:()=>fr,AxAIGoogleGeminiEmbedTypes:()=>rs,AxAIGoogleGeminiModel:()=>Rn,AxAIGoogleGeminiSafetyCategory:()=>Ar,AxAIGoogleGeminiSafetyThreshold:()=>xr,AxAIGrok:()=>Vt,AxAIGrokEmbedModels:()=>fs,AxAIGrokModel:()=>Pn,AxAIGroq:()=>Lt,AxAIGroqModel:()=>wn,AxAIHuggingFace:()=>Gt,AxAIHuggingFaceModel:()=>Cr,AxAIMistral:()=>Ut,AxAIMistralEmbedModels:()=>ls,AxAIMistralModel:()=>Sn,AxAIOllama:()=>Bt,AxAIOpenAI:()=>Pt,AxAIOpenAIBase:()=>pe,AxAIOpenAIEmbedModel:()=>Ot,AxAIOpenAIModel:()=>bn,AxAIOpenAIResponses:()=>qt,AxAIOpenAIResponsesBase:()=>vn,AxAIOpenAIResponsesImpl:()=>jt,AxAIOpenAIResponsesModel:()=>Mt,AxAIOpenRouter:()=>zt,AxAIRefusalError:()=>ae,AxAIReka:()=>Ht,AxAIRekaModel:()=>On,AxAIServiceAbortedError:()=>wt,AxAIServiceAuthenticationError:()=>it,AxAIServiceError:()=>Te,AxAIServiceNetworkError:()=>We,AxAIServiceResponseError:()=>tt,AxAIServiceStatusError:()=>ht,AxAIServiceStreamTerminatedError:()=>Be,AxAIServiceTimeoutError:()=>ft,AxAITogether:()=>Kt,AxAIWebLLM:()=>Wt,AxAIWebLLMModel:()=>En,AxAgent:()=>Xn,AxApacheTika:()=>ao,AxAssertionError:()=>Ve,AxBalancer:()=>pr,AxBaseAI:()=>de,AxBaseOptimizer:()=>Se,AxBootstrapFewShot:()=>rn,AxContentProcessingError:()=>je,AxDB:()=>$r,AxDBBase:()=>Fe,AxDBCloudflare:()=>Jt,AxDBManager:()=>Lr,AxDBMemory:()=>at,AxDBPinecone:()=>Qt,AxDBWeaviate:()=>Yt,AxDefaultCostTracker:()=>zn,AxDefaultResultReranker:()=>io,AxDockerSession:()=>Co,AxEmbeddingAdapter:()=>Ro,AxEvalUtil:()=>rl,AxFlow:()=>Qn,AxFlowDependencyAnalyzer:()=>on,AxFlowExecutionPlanner:()=>an,AxFlowSubContextImpl:()=>un,AxFlowTypedSubContextImpl:()=>Io,AxFluentFieldType:()=>ge,AxFunctionError:()=>Dn,AxFunctionProcessor:()=>Ln,AxGEPA:()=>Ao,AxGEPAFlow:()=>xo,AxGen:()=>we,AxGenerateError:()=>jn,AxHFDataLoader:()=>po,AxInstanceRegistry:()=>tn,AxLLMRequestTypeValues:()=>Bo,AxMCPClient:()=>wo,AxMCPHTTPSSETransport:()=>ko,AxMCPStreambleHTTPTransport:()=>vo,AxMediaNotSupportedError:()=>Pe,AxMemory:()=>Xt,AxMiPRO:()=>bo,AxMockAIService:()=>Sr,AxMultiServiceRouter:()=>vr,AxOptimizedProgramImpl:()=>Qe,AxProgram:()=>ut,AxPromptTemplate:()=>bt,AxProviderRouter:()=>Er,AxRateLimiterTokenUsage:()=>$t,AxSignature:()=>ce,AxSignatureBuilder:()=>Un,AxSimpleClassifier:()=>co,AxSimpleClassifierClass:()=>lo,AxSpanKindValues:()=>jo,AxStopFunctionCallException:()=>yt,AxStringUtil:()=>so,AxTestPrompt:()=>uo,agent:()=>wl,ai:()=>sa,ax:()=>fe,axAIAnthropicDefaultConfig:()=>Qo,axAIAnthropicVertexDefaultConfig:()=>_i,axAIAzureOpenAIBestConfig:()=>Li,axAIAzureOpenAICreativeConfig:()=>Di,axAIAzureOpenAIDefaultConfig:()=>Xo,axAIAzureOpenAIFastConfig:()=>$i,axAICohereCreativeConfig:()=>qi,axAICohereDefaultConfig:()=>ts,axAIDeepSeekCodeConfig:()=>zi,axAIDeepSeekDefaultConfig:()=>ns,axAIGoogleGeminiDefaultConfig:()=>ss,axAIGoogleGeminiDefaultCreativeConfig:()=>Ki,axAIGrokBestConfig:()=>oa,axAIGrokDefaultConfig:()=>Nr,axAIHuggingFaceCreativeConfig:()=>Wi,axAIHuggingFaceDefaultConfig:()=>as,axAIMistralBestConfig:()=>Vi,axAIMistralDefaultConfig:()=>wr,axAIOllamaDefaultConfig:()=>cs,axAIOllamaDefaultCreativeConfig:()=>Ji,axAIOpenAIBestConfig:()=>lr,axAIOpenAICreativeConfig:()=>cr,axAIOpenAIDefaultConfig:()=>At,axAIOpenAIFastConfig:()=>ur,axAIOpenAIResponsesBestConfig:()=>Qi,axAIOpenAIResponsesCreativeConfig:()=>Yi,axAIOpenAIResponsesDefaultConfig:()=>kn,axAIOpenRouterDefaultConfig:()=>ps,axAIRekaBestConfig:()=>ea,axAIRekaCreativeConfig:()=>ta,axAIRekaDefaultConfig:()=>Mn,axAIRekaFastConfig:()=>na,axAITogetherDefaultConfig:()=>ms,axAIWebLLMCreativeConfig:()=>ra,axAIWebLLMDefaultConfig:()=>hs,axAnalyzeChatPromptRequirements:()=>Xi,axAnalyzeRequestRequirements:()=>xt,axBaseAIDefaultConfig:()=>X,axBaseAIDefaultCreativeConfig:()=>me,axCheckMetricsHealth:()=>ia,axCreateDefaultColorLogger:()=>Uo,axCreateDefaultOptimizerColorLogger:()=>Us,axCreateDefaultOptimizerTextLogger:()=>sl,axCreateDefaultTextLogger:()=>ri,axCreateFlowColorLogger:()=>Jn,axCreateFlowTextLogger:()=>dl,axDefaultFlowLogger:()=>ml,axDefaultMetricsConfig:()=>bs,axDefaultOptimizerLogger:()=>qn,axDefaultOptimizerMetricsConfig:()=>Bs,axGetCompatibilityReport:()=>Gi,axGetFormatCompatibility:()=>Bi,axGetMetricsConfig:()=>la,axGetOptimizerMetricsConfig:()=>al,axGetProvidersWithMediaSupport:()=>Ui,axGlobals:()=>Q,axModelInfoAnthropic:()=>xn,axModelInfoCohere:()=>gr,axModelInfoDeepSeek:()=>hr,axModelInfoGoogleGemini:()=>yr,axModelInfoGrok:()=>_r,axModelInfoGroq:()=>Ir,axModelInfoHuggingFace:()=>Tr,axModelInfoMistral:()=>Rr,axModelInfoOpenAI:()=>Et,axModelInfoOpenAIResponses:()=>ar,axModelInfoReka:()=>Mr,axModelInfoTogether:()=>Pr,axModelInfoWebLLM:()=>Fr,axProcessContentForProvider:()=>Or,axRAG:()=>Sl,axScoreProvidersForRequest:()=>dr,axSelectOptimalProvider:()=>mr,axSpanAttributes:()=>j,axSpanEvents:()=>qe,axUpdateMetricsConfig:()=>aa,axUpdateOptimizerMetricsConfig:()=>il,axValidateChatRequestMessage:()=>St,axValidateChatResponseResult:()=>ir,axValidateProviderCapabilities:()=>Zo,f:()=>re,flow:()=>To,s:()=>ll});module.exports=Ll(pu);function Me({model:i,modelInfo:e,models:t}){let n=t?.find(l=>l.key===i),r=n&&"model"in n?n.model:i,o=e.find(l=>l.name===i);if(o)return o;let s=r.replace(/^(anthropic\.|openai\.)/,"").replace(/-latest$/,"").replace(/-\d{8}$/,"").replace(/-v\d+:\d+$/,"").replace(/@\d{8}$/,"").replace(/-\d{2,}(-[a-zA-Z0-9-]+)?$/,"").replace(/-v\d+@\d{8}$/,"").replace(/-v\d+$/,""),a=e.find(l=>l.name===s);return a||null}var Lo=(()=>{if(globalThis.crypto&&typeof globalThis.crypto.randomUUID=="function")return globalThis.crypto;throw new Error("Web Crypto API with randomUUID support not available. Requires Node.js 16+ or modern browser.")})();function xe(){return Lo.randomUUID()}async function Gl(i){let e=new TextEncoder,t=typeof i=="string"?e.encode(i):i,n=await Lo.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(n)).map(s=>s.toString(16).padStart(2,"0")).join("")}var $o=class{data="";update(e){return this.data+=e,this}digest(e){if(e!=="hex")throw new Error("Only hex encoding is supported");let n=new TextEncoder().encode(this.data),r=0;for(let o=0;o<n.length;o++){let s=n[o];r=(r<<5)-r+s,r=r&r}return Math.abs(r).toString(16).padStart(8,"0")}async digestAsync(){return Gl(this.data)}};function Ee(i){if(i!=="sha256")throw new Error("Only SHA-256 algorithm is supported");return new $o}function Js(){return Lo}var tr=class extends TransformStream{buffer="";currentEvent={rawData:""};dataParser;onError;constructor(e={}){super({transform:(t,n)=>this.handleChunk(t,n),flush:t=>this.handleFlush(t)}),this.dataParser=e.dataParser||JSON.parse,this.onError=e.onError||((t,n)=>{console.warn("Failed to parse event data:",t),console.log("Raw data that failed to parse:",n)})}handleChunk(e,t){this.buffer+=e,this.processBuffer(t)}handleFlush(e){this.processBuffer(e),this.currentEvent.rawData&&this.processEvent(e)}processBuffer(e){let n=this.buffer.replace(/\r\n|\r/g,`
`).split(`
...
`)?`
`:"")+r;break;case"id":this.currentEvent.id=r;break;case"retry":{let o=Number.parseInt(r,10);Number.isNaN(o)||(this.currentEvent.retry=o);break}}}processEvent(e){if(this.currentEvent.rawData){if(this.currentEvent.event||(this.currentEvent.event="message"),this.currentEvent.rawData.trim()==="[DONE]"){this.currentEvent={rawData:""};return}try{let t=this.dataParser(this.currentEvent.rawData);e.enqueue(t)}catch(t){this.onError(t,this.currentEvent.rawData)}this.currentEvent={rawData:""}}}};var Go=class{decoder;constructor(){this.decoder=new TextDecoder}transform(e,t){if(!(e instanceof ArrayBuffer||ArrayBuffer.isView(e)))throw new TypeError("Input data must be a BufferSource");let n=this.decoder.decode(e,{stream:!0});n.length!==0&&t.enqueue(n)}flush(e){let t=this.decoder.decode();t.length!==0&&e.enqueue(t)}},nr=class extends TransformStream{constructor(){super(new Go)}};var Ul={maxRetries:3,initialDelayMs:1e3,maxDelayMs:6e4,backoffFactor:2,retryableStatusCodes:[500,408,429,502,503,504]},Bl=globalThis.TextDecoderStream??nr,Te=class extends Error{constructor(t,n,r,o,s={}){super(t);this.url=n;this.requestBody=r;this.responseBody=o;this.name="AxAIServiceError",this.timestamp=new Date().toISOString(),this.errorId=xe(),this.context=s,this.stack=this.toString()}timestamp;errorId;context;toString(){return[`${this.name}: ${this.message}`,`URL: ${this.url}`,`Request Body: ${JSON.stringify(this.requestBody,null,2)}`,`Response Body: ${JSON.stringify(this.responseBody,null,2)}`,`Context: ${JSON.stringify(this.context,null,2)}`,`Timestamp: ${this.timestamp}`,`Error ID: ${this.errorId}`].join(`
`)}[Symbol.for("nodejs.util.inspect.custom")](t,n){return this.toString()}},ht=class extends Te{constructor(t,n,r,o,s,a){super(`HTTP ${t} - ${n}`,r,o,{httpStatus:t,httpStatusText:n,responseBody:s,...a});this.status=t;this.statusText=n;this.name="AxAIServiceStatusError"}},We=class extends Te{constructor(t,n,r,o,s){super(`Network Error: ${t.message}`,n,r,o,{originalErrorName:t.name,originalErrorStack:t.stack,...s});this.originalError=t;this.name="AxAIServiceNetworkError",this.stack=t.stack}},tt=class extends Te{constructor(e,t,n,r){super(e,t,n,void 0,r),this.name="AxAIServiceResponseError"}},Be=class extends Te{constructor(t,n,r,o){super("Stream terminated unexpectedly by remote host",t,n,void 0,{lastChunk:r,...o});this.lastChunk=r;this.name="AxAIServiceStreamTerminatedError"}},ft=class extends Te{constructor(e,t,n,r){super(`Request timed out after ${t}ms`,e,n,void 0,{timeoutMs:t,...r}),this.name="AxAIServiceTimeoutError"}},wt=class extends Te{constructor(e,t,n,r){super(`Request aborted${t?`: ${t}`:""}`,e,n,void 0,{abortReason:t,...r}),this.name="AxAIServiceAbortedError"}},it=class extends Te{constructor(e,t,n,r){super("Authentication failed",e,t,n,r),this.name="AxAIServiceAuthenticationError"}},ae=class extends Error{constructor(t,n,r){super(`Model refused to fulfill request: ${t}`);this.refusalMessage=t;this.model=n;this.requestId=r;this.name="AxAIRefusalError",this.timestamp=new Date().toISOString(),this.errorId=xe()}timestamp;errorId;toString(){return[`${this.name}: ${this.message}`,`Refusal: ${this.refusalMessage}`,this.model?`Model: ${this.model}`:"",this.requestId?`Request ID: ${this.requestId}`:"",`Timestamp: ${this.timestamp}`,`Error ID: ${this.errorId}`].filter(Boolean).join(`
...
`)}[Symbol.for("nodejs.util.inspect.custom")](t,n){return this.toString()}},je=class extends Error{constructor(t,n,r){super(`Failed to process ${n} during ${r}: ${t.message}`);this.originalError=t;this.contentType=n;this.processingStep=r;this.name="AxContentProcessingError",this.timestamp=new Date().toISOString(),this.errorId=xe()}timestamp;errorId;toString(){return[`${this.name}: ${this.message}`,`Content Type: ${this.contentType}`,`Processing Step: ${this.processingStep}`,`Original Error: ${this.originalError.message}`,`Timestamp: ${this.timestamp}`,`Error ID: ${this.errorId}`].join(`
`)}[Symbol.for("nodejs.util.inspect.custom")](t,n){return this.toString()}};async function Qs(i){try{return i.headers.get("content-type")?.includes("application/json")?await i.json():await i.clone().text()}catch(e){return`[ReadableStream - read failed: ${e.message}]`}}function Ys(i,e){return Math.min(e.maxDelayMs,e.initialDelayMs*e.backoffFactor**i)*(.75+Math.random()*.5)}function jl(){return{startTime:Date.now(),retryCount:0}}function Xs(i){i.retryCount++,i.lastRetryTime=Date.now()}function Zs(i,e,t,n){return t>=n.maxRetries?!1:e&&n.retryableStatusCodes.includes(e)?!0:i instanceof We&&!(i instanceof it)}var Re=async(i,e)=>{if(i.localCall)return await i.localCall(e,i.stream);if(!i.url)throw new Error("API URL is required when localCall is not provided");let t={...Ul,...i.retry},n=i.timeout,r=jl(),o,s=new URL(i.url),a=`${[s.pathname,i.name].filter(Boolean).join("/").replace(/\/+/g,"/")}${s.search}`,l=new URL(a,s);if(i.corsProxy){let p=l.href;l=new URL(`${i.corsProxy}?url=${encodeURIComponent(p)}`)}let c=xe();if(i.validateRequest&&!await i.validateRequest(e))throw new tt("Invalid request data",l.href,e,{validation:"request"});i.span?.setAttributes({"http.request.method":i.put?"PUT":"POST","url.full":l.href,"request.id":c,"request.startTime":r.startTime});let u=0;for(;;){let p=new AbortController;if(i.abortSignal){if(i.abortSignal.aborted)throw new wt(l.href,i.abortSignal.reason,e,{metrics:r});let d=()=>{p.abort(i.abortSignal.reason||"User aborted request")};i.abortSignal.addEventListener("abort",d,{once:!0});let m=p.abort.bind(p);p.abort=h=>{i.abortSignal.removeEventListener("abort",d),m(h)}}n&&(o=setTimeout(()=>{p.abort("Request timeout")},n));try{let d=await(i.fetch??fetch)(l,{method:i.put?"PUT":"POST",headers:{"Content-Type":"application/json","X-Request-ID":c,"X-Retry-Count":u.toString(),...i.headers},body:JSON.stringify(e),signal:p.signal});if(o&&clearTimeout(o),d.status===401||d.status===403){let x=await Qs(d);throw new it(l.href,e,x,{metrics:r})}if(d.status>=400&&Zs(new Error,d.status,u,t)){let x=Ys(u,t);u++,Xs(r),i.span?.addEvent("retry",{attempt:u,delay:x,status:d.status,"metrics.startTime":r.startTime,"metrics.retryCount":r.retryCount,"metrics.lastRetryTime":r.lastRetryTime}),await new Promise(b=>setTimeout(b,x));continue}if(d.status>=400){let x=await Qs(d);throw new ht(d.status,d.statusText,l.href,e,x,{metrics:r})}if(!i.stream){let x=await d.json();if(i.validateResponse&&!await i.validateResponse(x))throw new tt("Invalid response data",l.href,e,{validation:"response"});return i.span?.setAttributes({"response.time":Date.now()-r.startTime,"response.retries":r.retryCount}),x}if(!d.body)throw new tt("Response body is null",l.href,e,{metrics:r});let m,h=0;if(typeof window<"u"&&typeof EventSource<"u")return new ReadableStream({start(x){let b=d.body.getReader(),I=new TextDecoder,S="";async function T(){try{for(;;){let{done:w,value:y}=await b.read();if(w){f=!0,x.close();break}S+=I.decode(y,{stream:!0});let k=S.split(`

`);S=k.pop()||"";for(let E of k){if(!E.trim())continue;let M=E.split(`
`),R="",P="message";for(let C of M)C.startsWith("data: ")?R=C.slice(6):C.startsWith("event: ")&&(P=C.slice(7));if(R){if(R==="[DONE]"){x.close();return}try{let C=JSON.parse(R);m=C,h++,r.streamChunks=h,r.lastChunkTime=Date.now(),x.enqueue(C),i.span?.addEvent("stream.chunk",{"stream.chunks":h,"stream.duration":Date.now()-r.startTime,"response.retries":r.retryCount,"sse.event.type":P})}catch(C){i.debug&&console.warn("Skipping non-JSON SSE data:",R,C)}}}}}catch(w){let y=w,k={...r,streamDuration:Date.now()-r.startTime};y.name==="AbortError"||y.message?.includes("aborted")?x.error(new Be(l.href,e,m,{streamMetrics:k})):x.error(new We(y,l.href,e,"[ReadableStream - consumed during streaming]",{streamMetrics:k}))}finally{b.releaseLock()}}T()}});let g=new TransformStream({transform(x,b){m=x,h++,r.streamChunks=h,r.lastChunkTime=Date.now(),b.enqueue(x),i.span?.addEvent("stream.chunk",{"stream.chunks":h,"stream.duration":Date.now()-r.startTime,"response.retries":r.retryCount})}}),f=!1;return new ReadableStream({start(x){let b=d.body.pipeThrough(new Bl).pipeThrough(new tr).pipeThrough(g).getReader();async function I(){try{for(;;){let{done:S,value:T}=await b.read();if(S){f||(f=!0,x.close());break}if(f)break;x.enqueue(T)}}catch(S){let T=S,w={...r,streamDuration:Date.now()-r.startTime};throw T.name==="AbortError"||T.message?.includes("aborted")?x.error(new Be(l.href,e,m,{streamMetrics:w})):T instanceof TypeError&&T.message.includes("cancelled")?x.error(new Be(l.href,e,m,{streamMetrics:w,cancelReason:"Stream cancelled by client"})):x.error(new We(T,l.href,e,"[ReadableStream - consumed during streaming]",{streamMetrics:w})),T}finally{o&&clearTimeout(o),b.releaseLock()}}I()},cancel(){f=!0}})}catch(d){if(d instanceof Error&&d.name==="AbortError")throw i.abortSignal?.aborted?new wt(l.href,i.abortSignal.reason,e,{metrics:r}):new ft(l.href,n||0,e,{metrics:r});if(i.span?.isRecording()&&(i.span.recordException(d),i.span.setAttributes({"error.time":Date.now()-r.startTime,"error.retries":r.retryCount})),d instanceof We&&Zs(d,void 0,u,t)){let m=Ys(u,t);u++,Xs(r),i.span?.addEvent("retry",{attempt:u,delay:m,error:d.message,"metrics.startTime":r.startTime,"metrics.retryCount":r.retryCount,"metrics.lastRetryTime":r.lastRetryTime}),await new Promise(h=>setTimeout(h,m));continue}throw d instanceof Te&&(d.context.metrics=r),d}finally{o!==void 0&&clearTimeout(o)}}};var vt=require("@opentelemetry/api");var Q={signatureStrict:!0,tracer:void 0,meter:void 0,logger:void 0,optimizerLogger:void 0,debug:void 0,abortSignal:void 0,cachingFunction:void 0,functionResultFormatter:i=>typeof i=="string"?i:i==null?"":JSON.stringify(i,null,2)};var Ce=class{ANSI_WHITE_BRIGHT="\x1B[97m";ANSI_GREEN_BRIGHT="\x1B[92m";ANSI_BLUE_BRIGHT="\x1B[94m";ANSI_RED_BRIGHT="\x1B[91m";ANSI_YELLOW_BRIGHT="\x1B[93m";ANSI_YELLOW="\x1B[93m";ANSI_RED="\x1B[91m";ANSI_RESET="\x1B[0m";ANSI_ORANGE="\x1B[38;5;208m";ANSI_WHITE="\x1B[37m";ANSI_CYAN_BRIGHT="\x1B[96m";ANSI_MAGENTA_BRIGHT="\x1B[95m";ANSI_GRAY="\x1B[90m";ANSI_GREEN="\x1B[32m";ANSI_CYAN="\x1B[36m";ANSI_MAGENTA="\x1B[35m";ANSI_BLUE="\x1B[34m";ANSI_YELLOW_DIM="\x1B[33m";colorize(e,t){return`${t}${e}${this.ANSI_RESET}`}whiteBright(e){return this.colorize(e,this.ANSI_WHITE_BRIGHT)}greenBright(e){return this.colorize(e,this.ANSI_GREEN_BRIGHT)}blueBright(e){return this.colorize(e,this.ANSI_BLUE_BRIGHT)}redBright(e){return this.colorize(e,this.ANSI_RED_BRIGHT)}white(e){return this.colorize(e,this.ANSI_WHITE)}yellow(e){return this.colorize(e,this.ANSI_YELLOW)}yellowBright(e){return this.colorize(e,this.ANSI_YELLOW_BRIGHT)}red(e){return this.colorize(e,this.ANSI_RED)}orange(e){return this.colorize(e,this.ANSI_ORANGE)}cyanBright(e){return this.colorize(e,this.ANSI_CYAN_BRIGHT)}magentaBright(e){return this.colorize(e,this.ANSI_MAGENTA_BRIGHT)}gray(e){return this.colorize(e,this.ANSI_GRAY)}green(e){return this.colorize(e,this.ANSI_GREEN)}cyan(e){return this.colorize(e,this.ANSI_CYAN)}magenta(e){return this.colorize(e,this.ANSI_MAGENTA)}blue(e){return this.colorize(e,this.ANSI_BLUE)}yellowDim(e){return this.colorize(e,this.ANSI_YELLOW_DIM)}};var wu=new Ce,ei=i=>{console.log(i)},ti=(i,e,t)=>{let n=(r,o)=>t&&o&&o in t?t[o](r):r;switch(i.role){case"system":return`${n("[ SYSTEM ]","magentaBright")}
...
${n(JSON.stringify(i),"gray")}`}},Uo=(i=ei)=>{let e=new Ce,t=e.gray(`${"\u2500".repeat(60)}
`);return n=>{let r=n,o="";switch(r.name){case"ChatRequestChatPrompt":o=`
${e.blueBright(`[ CHAT REQUEST Step ${r.step} ]`)}
${t}
`,r.value.forEach((s,a)=>{o+=ti(s,void 0,e),a<r.value.length-1&&(o+=`
${t}
`)}),o+=`
...
`)}),o+=t;break}default:o=e.gray(JSON.stringify(r,null,2))}i(o)}},ni=Uo(),ri=(i=ei)=>{let e="\u2500".repeat(60);return t=>{let n=t,r="";switch(n.name){case"ChatRequestChatPrompt":r=`
[ CHAT REQUEST Step ${n.step} ]
${e}
`,n.value.forEach((o,s)=>{r+=ti(o),s<n.value.length-1&&(r+=`
${e}
`)}),r+=`
...
`)}
        ...
        }`});if(r.errors)throw new Error(`Weaviate query failed: ${r.errors.map(({message:a})=>a).join(", ")}`);let o=r.data.Get[e.table];return o?{matches:o.map(a=>({id:a.id,score:1,metadata:a}))}:{matches:[]}}};var $r=class{db;constructor(e){switch(e.name){case"weaviate":this.db=new Yt(e);break;case"pinecone":this.db=new Qt(e);break;case"cloudflare":this.db=new Jt(e);break;case"memory":this.db=new at(e);break;default:throw new Error("Unknown DB")}}async upsert(e,t){return await this.db.upsert(e,t)}async batchUpsert(e,t){return await this.db.batchUpsert(e,t)}async query(e){return await this.db.query(e)}};var xs="_internal",Lr=class{ai;db;chunker;rewriter;reranker;constructor({ai:e,db:t,config:n}){this.ai=e,this.db=t,this.chunker=n?.chunker??this.defaultChunker,this.reranker=n?.reranker,this.rewriter=n?.rewriter}defaultChunker=e=>e.split(/\n\n+/);insert=async(e,t)=>{try{let n=Array.isArray(e)?e.join(`

`):e,r=this.chunker(n).filter(c=>c.length>0),o=t?.maxWordsPerChunk,s=t?.minWordsPerChunk,a=sc({initialChunks:r,minWordsPerChunk:s,maxWordsPerChunk:o}),l=t?.batchSize??10;for(let c=0;c<a.length;c+=l){let u=a.slice(c,c+l),d=(await this.ai.embed({texts:u},{abortSignal:t?.abortSignal})).embeddings.map((m,h)=>({id:`chunk_${Date.now()+h}`,table:xs,values:m,metadata:{text:u[h]??""}})).filter(m=>m.metadata?.text&&m.metadata?.text.length>0);await this.db.batchUpsert(d)}}catch(n){throw new Error(`Error processing text: ${n}`)}};query=async(e,{topPercent:t,abortSignal:n}={})=>{let r=Array.isArray(e)?e:[e];if(typeof r[0]=="string"&&this.rewriter)for(let[l,c]of r.entries()){let{rewrittenQuery:u}=await this.rewriter.forward(this.ai,{query:c});r[l]=u}let o;typeof r[0]=="string"?o=(await this.ai.embed({texts:r},{abortSignal:n})).embeddings.map(c=>this.db.query({table:xs,values:c})):o=r.map(l=>this.db.query({table:xs,values:l}));let s=await Promise.all(o),a=[];for(let{matches:l}of s){let c=l.filter(d=>d.metadata?.text&&d.metadata?.text.length>0).map(({score:d,metadata:m})=>({score:d,text:m?.text??""})),u=t&&t>1?t/100:t,p=u?ic(c,u):c;if(this.reranker){let{rankedItems:d}=await this.reranker.forward(this.ai,{query:r[0],items:p.map(h=>h.text)}),m=d.map(h=>p.find(A=>A.text===h)).filter(h=>h!==void 0);a.push(m)}else a.push(p)}return a}},sc=({initialChunks:i,maxWordsPerChunk:e=350,minWordsPerChunk:t=250})=>{let n=[],r="",o=0;return i.forEach(s=>{let a=s.split(/\s+/),l=a.length;if(o+l<=e)r+=`${s}
...
`,o=l}),(o>t||n.length===0)&&n.push(r.trim()),n},ic=(i,e=.1)=>{let t=[...i].sort((r,o)=>r.score-o.score),n=Math.ceil(t.length*e);return t.slice(0,n)};var nn=require("@opentelemetry/api");var _n=class{data=[];seenTags=new Set;addRequest(e,t){this.data.push(...e.map(n=>{let r=structuredClone(n);return{role:n.role,chat:[{index:t,value:r}]}}))}addFunctionResults(e){let t=e.map(({index:r,...o})=>({index:r,value:structuredClone(o)})),n=this.getLast();n?.role==="function"?n.chat.push(...t):this.data.push({role:"function",chat:t})}addResponse(e){let t=e.map(({index:n,...r})=>({index:n,value:structuredClone(r)}));this.data.push({role:"assistant",chat:t})}updateResult({content:e,name:t,functionCalls:n,thought:r,thoughtBlock:o,index:s}){let a=this.data.at(-1);if(!a||a.role!=="assistant"||a.role==="assistant"&&!a.updatable){this.data.push({role:"assistant",updatable:!0,chat:[{index:s,value:structuredClone({content:e,name:t,functionCalls:n,thought:r,thoughtBlock:o})}]});return}let l=a.chat.find(c=>c.index===s);if(!l){a.chat.push({index:s,value:structuredClone({content:e,name:t,functionCalls:n,thought:r,thoughtBlock:o})});return}if(typeof e=="string"&&e.trim()!==""&&(l.value.content=e),typeof t=="string"&&t.trim()!==""&&(l.value.name=t),Array.isArray(n)&&n.length>0&&(l.value.functionCalls=n),typeof r=="string"&&r.trim()!==""){let c=l.value.thought;l.value.thought=typeof c=="string"?c+r:r}if(o&&typeof o=="object"){let c=l.value.thoughtBlock??{},u={data:(c.data??"")+(o.data??""),encrypted:!!c.encrypted||!!o.encrypted,...o.signature?{signature:o.signature}:{}};l.value.thoughtBlock=u}}addTag(e){let t=this.data.at(-1);t&&(t.tags||(t.tags=[]),t.tags.includes(e)||t.tags.push(e),this.seenTags.add(e))}rewindToTag(e){let t=this.data.findIndex(n=>n.tags?.includes(e));if(t===-1){if(!this.seenTags.has(e))throw new Error(`Tag "${e}" not found`);return[]}return this.data.splice(t)}removeByTag(e){let t=this.data.reduce((n,r,o)=>(r.tags?.includes(e)&&n.push(o),n),[]);return t.length===0?[]:t.reverse().map(n=>this.data.splice(n,1).at(0)).filter(n=>n!==void 0).reverse()}history(e){let t=[];for(let{role:n,chat:r}of this.data){let o;n==="function"?o=r.filter(s=>s.index===e).map(s=>s.value):o=r.find(s=>s.index===e)?.value,Array.isArray(o)&&o.length>0?t.push(...o.map(s=>({...s,role:n}))):typeof o=="object"&&o!==null&&t.push({...o,role:n})}return t}getLast(){return this.data.at(-1)}reset(){this.data=[],this.seenTags=new Set}},Xt=class{memories=new Map;defaultMemory;constructor(){this.defaultMemory=new _n}getMemory(e){return e?(this.memories.has(e)||this.memories.set(e,new _n),this.memories.get(e)):this.defaultMemory}addRequest(e,t){for(let n of e)St(n);this.getMemory(t).addRequest(e,0)}addResponse(e,t){ir(e),this.getMemory(t).addResponse(e)}addFunctionResults(e,t){this.getMemory(t).addFunctionResults(e)}updateResult(e,t){this.getMemory(t).updateResult(e)}addTag(e,t){this.getMemory(t).addTag(e)}rewindToTag(e,t){return this.getMemory(t).rewindToTag(e)}removeByTag(e,t){return this.getMemory(t).removeByTag(e)}history(e,t){return this.getMemory(t).history(e)}getLast(e){return this.getMemory(e).getLast()}reset(e){e?this.memories.set(e,new _n):this.defaultMemory.reset()}};var Ve=class extends Error{constructor({message:e}){super(e),this.name="AxAssertionError"}getFixingInstructions=()=>{let e=[],t=this.message.trim();return e.push({name:"error",title:"Follow these instructions",description:t+(t.endsWith(".")?"":".")}),e};toString(){return`${this.name}: ${this.message}`}[Symbol.for("nodejs.util.inspect.custom")](e,t){return this.toString()}},Gr=async(i,e)=>{for(let t of i){let{fn:n,message:r}=t,o=await n(e);if(o!==void 0){if(typeof o=="string")throw new Ve({message:o});if(!o)throw r?new Ve({message:r}):new Error("Assertion Failed: No message provided for assertion")}}},ys=async(i,e,t,n=!1)=>{if(!e.currField||e.s===-1||!i||i.length===0)return;let r=i.filter(s=>s.fieldName===e.currField?.name);if(r.length===0)return;let o=t.substring(e.s);for(let s of r){let{message:a,fn:l}=s,c=await l(o,n);if(c!==void 0){if(typeof c=="string")throw new Ve({message:c});if(!c&&a)throw new Ve({message:a})}}};var bs={enabled:!0,enabledCategories:["generation","streaming","functions","errors","performance"],maxLabelLength:100,samplingRate:1},Nn,Is=i=>{if(Nn)return Nn;let e=i??Q.meter;if(e)return Nn=ac(e),Nn};var ia=()=>{let i=[];return Q.meter||i.push("Global meter not initialized"),!Nn&&Q.meter&&i.push("Metrics instruments not created despite available meter"),{healthy:i.length===0,issues:i}},ac=i=>({generationLatencyHistogram:i.createHistogram("ax_gen_generation_duration_ms",{description:"End-to-end duration of AxGen generation requests",unit:"ms"}),generationRequestsCounter:i.createCounter("ax_gen_generation_requests_total",{description:"Total number of AxGen generation requests"}),generationErrorsCounter:i.createCounter("ax_gen_generation_errors_total",{description:"Total number of failed AxGen generations"}),multiStepGenerationsCounter:i.createCounter("ax_gen_multistep_generations_total",{description:"Total number of generations that required multiple steps"}),stepsPerGenerationHistogram:i.createHistogram("ax_gen_steps_per_generation",{description:"Number of steps taken per generation"}),maxStepsReachedCounter:i.createCounter("ax_gen_max_steps_reached_total",{description:"Total number of generations that hit max steps limit"}),validationErrorsCounter:i.createCounter("ax_gen_validation_errors_total",{description:"Total number of validation errors encountered"}),assertionErrorsCounter:i.createCounter("ax_gen_assertion_errors_total",{description:"Total number of assertion errors encountered"}),errorCorrectionAttemptsHistogram:i.createHistogram("ax_gen_error_correction_attempts",{description:"Number of error correction attempts per generation"}),errorCorrectionSuccessCounter:i.createCounter("ax_gen_error_correction_success_total",{description:"Total number of successful error corrections"}),errorCorrectionFailureCounter:i.createCounter("ax_gen_error_correction_failure_total",{description:"Total number of failed error corrections"}),maxRetriesReachedCounter:i.createCounter("ax_gen_max_retries_reached_total",{description:"Total number of generations that hit max retries limit"}),functionsEnabledGenerationsCounter:i.createCounter("ax_gen_functions_enabled_generations_total",{description:"Total number of generations with functions enabled"}),functionCallStepsCounter:i.createCounter("ax_gen_function_call_steps_total",{description:"Total number of steps that included function calls"}),functionsExecutedPerGenerationHistogram:i.createHistogram("ax_gen_functions_executed_per_generation",{description:"Number of unique functions executed per generation"}),functionErrorCorrectionCounter:i.createCounter("ax_gen_function_error_correction_total",{description:"Total number of function-related error corrections"}),fieldProcessorsExecutedCounter:i.createCounter("ax_gen_field_processors_executed_total",{description:"Total number of field processors executed"}),streamingFieldProcessorsExecutedCounter:i.createCounter("ax_gen_streaming_field_processors_executed_total",{description:"Total number of streaming field processors executed"}),streamingGenerationsCounter:i.createCounter("ax_gen_streaming_generations_total",{description:"Total number of streaming generations"}),streamingDeltasEmittedCounter:i.createCounter("ax_gen_streaming_deltas_emitted_total",{description:"Total number of streaming deltas emitted"}),streamingFinalizationLatencyHistogram:i.createHistogram("ax_gen_streaming_finalization_duration_ms",{description:"Duration of streaming response finalization",unit:"ms"}),samplesGeneratedHistogram:i.createHistogram("ax_gen_samples_generated",{description:"Number of samples generated per request"}),resultPickerUsageCounter:i.createCounter("ax_gen_result_picker_usage_total",{description:"Total number of times result picker was used"}),resultPickerLatencyHistogram:i.createHistogram("ax_gen_result_picker_duration_ms",{description:"Duration of result picker execution",unit:"ms"}),inputFieldsGauge:i.createGauge("ax_gen_input_fields",{description:"Number of input fields in signature"}),outputFieldsGauge:i.createGauge("ax_gen_output_fields",{description:"Number of output fields in signature"}),examplesUsedGauge:i.createGauge("ax_gen_examples_used",{description:"Number of examples used in generation"}),demosUsedGauge:i.createGauge("ax_gen_demos_used",{description:"Number of demos used in generation"}),promptRenderLatencyHistogram:i.createHistogram("ax_gen_prompt_render_duration_ms",{description:"Duration of prompt template rendering",unit:"ms"}),extractionLatencyHistogram:i.createHistogram("ax_gen_extraction_duration_ms",{description:"Duration of value extraction from responses",unit:"ms"}),assertionLatencyHistogram:i.createHistogram("ax_gen_assertion_duration_ms",{description:"Duration of assertion checking",unit:"ms"}),stateCreationLatencyHistogram:i.createHistogram("ax_gen_state_creation_duration_ms",{description:"Duration of state creation for multiple samples",unit:"ms"}),memoryUpdateLatencyHistogram:i.createHistogram("ax_gen_memory_update_duration_ms",{description:"Duration of memory updates during generation",unit:"ms"})}),Ur=bs,aa=i=>{Ur={...Ur,...i}},la=()=>({...Ur}),He=i=>{let e={};for(let[t,n]of Object.entries(i))if(n!=null){let r=String(n),o=Ur.maxLabelLength;e[t]=r.length>o?r.substring(0,o):r}return e},ca=(i,e,t,n,r,o)=>{try{let s=He({success:t.toString(),...n?{signature:n}:{},...r?{ai_service:r}:{},...o?{model:o}:{}});i.generationLatencyHistogram&&i.generationLatencyHistogram.record(e,s),i.generationRequestsCounter&&i.generationRequestsCounter.add(1,s),!t&&i.generationErrorsCounter&&i.generationErrorsCounter.add(1,s)}catch(s){console.warn("Failed to record generation metric:",s)}},Br=(i,e,t,n)=>{try{let r=He({...n?{signature:n}:{}});e>1&&i.multiStepGenerationsCounter&&i.multiStepGenerationsCounter.add(1,r),i.stepsPerGenerationHistogram&&i.stepsPerGenerationHistogram.record(e,r),e>=t&&i.maxStepsReachedCounter&&i.maxStepsReachedCounter.add(1,r)}catch(r){console.warn("Failed to record multi-step metric:",r)}},Ts=(i,e,t)=>{try{let n=He({error_type:e,...t?{signature:t}:{}});e==="validation"&&i.validationErrorsCounter&&i.validationErrorsCounter.add(1,n),e==="assertion"&&i.assertionErrorsCounter&&i.assertionErrorsCounter.add(1,n)}catch(n){console.warn("Failed to record validation error metric:",n)}},ua=(i,e)=>{try{let t=He({error_type:"refusal",...e?{signature:e}:{}});i.validationErrorsCounter&&i.validationErrorsCounter.add(1,t)}catch(t){console.warn("Failed to record refusal error metric:",t)}},Cs=(i,e,t,n,r)=>{try{let o=He({success:t.toString(),...r?{signature:r}:{}});i.errorCorrectionAttemptsHistogram&&i.errorCorrectionAttemptsHistogram.record(e,o),t&&i.errorCorrectionSuccessCounter&&i.errorCorrectionSuccessCounter.add(1,o),t||(i.errorCorrectionFailureCounter&&i.errorCorrectionFailureCounter.add(1,o),e>=n&&i.maxRetriesReachedCounter&&i.maxRetriesReachedCounter.add(1,o))}catch(o){console.warn("Failed to record error correction metric:",o)}},pa=(i,e,t,n,r=!1,o)=>{try{let s=He({functions_enabled:e.toString(),had_function_calls:n.toString(),...o?{signature:o}:{}});e&&i.functionsEnabledGenerationsCounter&&i.functionsEnabledGenerationsCounter.add(1,s),n&&i.functionCallStepsCounter&&i.functionCallStepsCounter.add(1,s),t>0&&i.functionsExecutedPerGenerationHistogram&&i.functionsExecutedPerGenerationHistogram.record(t,s),r&&i.functionErrorCorrectionCounter&&i.functionErrorCorrectionCounter.add(1,s)}catch(s){console.warn("Failed to record function calling metric:",s)}},da=(i,e,t,n)=>{try{let r=He({...n?{signature:n}:{}});e>0&&i.fieldProcessorsExecutedCounter&&i.fieldProcessorsExecutedCounter.add(e,r),t>0&&i.streamingFieldProcessorsExecutedCounter&&i.streamingFieldProcessorsExecutedCounter.add(t,r)}catch(r){console.warn("Failed to record field processing metric:",r)}},ma=(i,e,t,n,r)=>{try{let o=He({is_streaming:e.toString(),...r?{signature:r}:{}});e&&i.streamingGenerationsCounter&&i.streamingGenerationsCounter.add(1,o),t>0&&i.streamingDeltasEmittedCounter&&i.streamingDeltasEmittedCounter.add(t,o),n&&i.streamingFinalizationLatencyHistogram&&i.streamingFinalizationLatencyHistogram.record(n,o)}catch(o){console.warn("Failed to record streaming metric:",o)}},ga=(i,e,t,n,r)=>{try{let o=He({result_picker_used:t.toString(),...r?{signature:r}:{}});i.samplesGeneratedHistogram&&i.samplesGeneratedHistogram.record(e,o),t&&i.resultPickerUsageCounter&&i.resultPickerUsageCounter.add(1,o),n&&i.resultPickerLatencyHistogram&&i.resultPickerLatencyHistogram.record(n,o)}catch(o){console.warn("Failed to record samples metric:",o)}},ha=(i,e,t,n,r,o)=>{try{let s=He({...o?{signature:o}:{}});i.inputFieldsGauge&&i.inputFieldsGauge.record(e,s),i.outputFieldsGauge&&i.outputFieldsGauge.record(t,s),i.examplesUsedGauge&&i.examplesUsedGauge.record(n,s),i.demosUsedGauge&&i.demosUsedGauge.record(r,s)}catch(s){console.warn("Failed to record signature complexity metrics:",s)}},jr=(i,e,t,n)=>{try{let r=He({metric_type:e,...n?{signature:n}:{}});switch(e){case"prompt_render":i.promptRenderLatencyHistogram&&i.promptRenderLatencyHistogram.record(t,r);break;case"extraction":i.extractionLatencyHistogram&&i.extractionLatencyHistogram.record(t,r);break;case"assertion":i.assertionLatencyHistogram&&i.assertionLatencyHistogram.record(t,r);break;case"state_creation":i.stateCreationLatencyHistogram&&i.stateCreationLatencyHistogram.record(t,r);break;case"memory_update":i.memoryUpdateLatencyHistogram&&i.memoryUpdateLatencyHistogram.record(t,r);break}}catch(r){console.warn("Failed to record performance metric:",r)}};var Zt=i=>{let e=(()=>{switch(i?.name){case"string":return"string";case"number":return"number";case"boolean":return"boolean";case"date":return'date ("YYYY-MM-DD" format)';case"datetime":return'date time ("YYYY-MM-DD HH:mm Timezone" format)';case"json":return"JSON object";case"class":return"classification class";case"code":return"code";default:return"string"}})();return i?.isArray?`json array of ${e} items`:e},he=class extends Error{constructor(e){super(e),this.name="ValidationError"}getFixingInstructions=()=>[{name:"outputError",title:"Invalid Field **Only return the invalid, remaining fields**",description:this.message}];toString(){return`${this.name}: ${this.message}`}[Symbol.for("nodejs.util.inspect.custom")](e,t){return this.toString()}},fa=i=>{let t=i.map(n=>`'${n.title}' (${Zt(n.type)})`).join(", ");return new he(`Required field not found: ${t}. Add a line starting with the exact label followed by a colon (e.g., "${i[0]?.title}:") and then provide a valid ${Zt(i[0]?.type)} value. Keep the output concise and avoid unrelated text.`)},qr=i=>new he(`Expected (Required) field not found: '${i.title}'. Begin a new section with "${i.title}:" and then provide a valid ${Zt(i.type)} value directly after.`);var zr=i=>new he(`Required field is missing: '${i.title}'. After the "${i.title}:" label, provide a non-empty ${Zt(i.type)}. Do not use null, undefined, or leave it blank.`),Aa=(i,e)=>new he(`Invalid JSON: ${e} in field '${i.title}'. Return only valid JSON. Prefer a fenced code block containing a single JSON object or array with no trailing text.`),xa=(i,e)=>new he(`Invalid Array: ${e} for '${i.title}'. Provide a JSON array of ${Zt(i.type)} items (e.g., [ ... ]). Markdown lists are also accepted if each item is on its own line starting with a hyphen.`),ya=(i,e,t)=>new he(`Field '${i.title}' has an invalid value '${e}': ${t}. Provide a ${Zt(i.type)}. Ensure formatting exactly matches the expected type.`),ba=(i,e,t)=>new he(`Invalid date for '${i.title}': ${t}. Use the exact format YYYY-MM-DD (e.g., 2024-05-09). You provided: ${e}.`),Ia=(i,e,t)=>new he(`Invalid date/time for '${i.title}': ${t}. Use the format YYYY-MM-DD HH:mm or YYYY-MM-DD HH:mm:ss followed by a valid timezone (e.g., America/New_York). You provided: ${e}.`),Rs=(i,e,t)=>new he(`Invalid URL for '${i.title}': ${t}. Use a valid URL format (e.g., https://example.com). You provided: ${e}.`),en=(i,e,t,n)=>{let r=`Field '${i.title}' failed validation: `;return t==="minLength"?r+=`String must be at least ${n} characters long. You provided: "${e}" (${e.length} characters).`:t==="maxLength"?r+=`String must be at most ${n} characters long. You provided: "${e}" (${e.length} characters).`:t==="pattern"?r+=`String must match pattern /${n}/. You provided: "${e}".`:t==="format"&&(r+=`String must be a ${n}. You provided: "${e}".`),new he(r)},ws=(i,e,t,n)=>{let r=`Field '${i.title}' failed validation: `;return t==="minimum"?r+=`Number must be at least ${n}. You provided: ${e}.`:t==="maximum"&&(r+=`Number must be at most ${n}. You provided: ${e}.`),new he(r)};var Ta=({error:i,errCount:e,debug:t,logger:n,metricsInstruments:r,signatureName:o,span:s})=>{let a=i.getFixingInstructions();if(t&&n){let l=a?.map(c=>c.title).join(", ")??"";ci(i,e,l,n)}return r&&Ts(r,"validation",o),s&&s.addEvent("validation.error",{message:i.toString(),fixing_instructions:a?.map(l=>l.title).join(", ")??""}),a},Ca=({error:i,errCount:e,debug:t,logger:n,metricsInstruments:r,signatureName:o,span:s})=>{let a=i.getFixingInstructions();if(t&&n){let l=a?.map(c=>c.title).join(", ")??"";ui(i,e,l,n)}return r&&Ts(r,"assertion",o),s&&s.addEvent("assertion.error",{message:i.toString(),fixing_instructions:a?.map(l=>l.title).join(", ")??""}),a},Ra=({error:i,errCount:e,debug:t,logger:n,metricsInstruments:r,signatureName:o,span:s})=>{t&&n&&pi(i,e,n),r&&ua(r,o),s&&s.addEvent("refusal.error",{message:i.toString()})};function wa(i,e){if(!e)return i;let t=[];if(e.format==="email"&&t.push("Must be a valid email address format"),(e.format==="uri"||e.format==="url"||e.name==="url")&&t.push("Must be a valid URL format"),(e.name==="string"||e.name==="code"||e.name==="url"||e.name==="date"||e.name==="datetime")&&(e.minLength!==void 0&&e.maxLength!==void 0?t.push(`Minimum length: ${e.minLength} characters, maximum length: ${e.maxLength} characters`):e.minLength!==void 0?t.push(`Minimum length: ${e.minLength} characters`):e.maxLength!==void 0&&t.push(`Maximum length: ${e.maxLength} characters`)),e.name==="number"&&(e.minimum!==void 0&&e.maximum!==void 0?t.push(`Minimum value: ${e.minimum}, maximum value: ${e.maximum}`):e.minimum!==void 0?t.push(`Minimum value: ${e.minimum}`):e.maximum!==void 0&&t.push(`Maximum value: ${e.maximum}`)),e.pattern!==void 0){if(!e.patternDescription)throw new Error(`Field with pattern '${e.pattern}' must include a patternDescription to explain the pattern to the LLM`);t.push(e.patternDescription)}if(e.name==="date"&&t.push("Format: YYYY-MM-DD"),e.name==="datetime"&&t.push("Format: ISO 8601 date-time"),t.length===0)return i;let n=t.join(". ");return!i||i.trim().length===0?n:`${i.trim().endsWith(".")?i.trim():`${i.trim()}.`} ${n}`}function Wr(i,e="Schema"){if("name"in i&&"type"in i)return Hr(i);let t={},n=[];for(let r of i){if(r.isInternal)continue;let o=Hr(r);t[r.name]=o,r.isOptional||n.push(r.name)}return{type:"object",title:e,properties:t,required:n,additionalProperties:!1}}function Hr(i,e=!1){let t=i.type,n=wa(i.description,t);if(e&&t?.name&&(t.name==="image"||t.name==="audio"||t.name==="file"))throw new Error(`Media type '${t.name}' is not allowed in nested object fields. Media types (image, audio, file) can only be used as top-level input fields. Field: ${i.name}`);let r={};if(n&&(r.description=n),t?.isArray)if(r.type="array",t.fields){r.items={type:"object",properties:{},required:[],additionalProperties:!1};for(let[o,s]of Object.entries(t.fields)){let a={name:o,description:s.description,type:{name:s.type,isArray:s.isArray,options:s.options?[...s.options]:void 0,fields:s.fields,minLength:s.minLength,maxLength:s.maxLength,minimum:s.minimum,maximum:s.maximum,pattern:s.pattern,patternDescription:s.patternDescription,format:s.format},isOptional:s.isOptional,isInternal:s.isInternal};r.items.properties[o]=Hr(a,!0),s.isOptional||r.items.required.push(o)}}else if(t.name==="class"&&t.options)r.items={type:"string",enum:t.options};else{let o=wa(i.description,t);r.items={type:Sa(t.name)},o&&(r.items.description=o),t.name==="string"||t.name==="code"||t.name==="url"||t.name==="date"||t.name==="datetime"?(t.minLength!==void 0&&(r.items.minLength=t.minLength),t.maxLength!==void 0&&(r.items.maxLength=t.maxLength),t.pattern!==void 0&&(r.items.pattern=t.pattern),t.format!==void 0&&(r.items.format=t.format)):t.name==="number"&&(t.minimum!==void 0&&(r.items.minimum=t.minimum),t.maximum!==void 0&&(r.items.maximum=t.maximum))}else if(t?.name==="object"&&t.fields){r.type="object",r.properties={},r.required=[],r.additionalProperties=!1;for(let[o,s]of Object.entries(t.fields)){let a={name:o,description:s.description,type:{name:s.type,isArray:s.isArray,options:s.options?[...s.options]:void 0,fields:s.fields,minLength:s.minLength,maxLength:s.maxLength,minimum:s.minimum,maximum:s.maximum,pattern:s.pattern,patternDescription:s.patternDescription,format:s.format},isOptional:s.isOptional,isInternal:s.isInternal};r.properties[o]=Hr(a,!0),s.isOptional||r.required.push(o)}}else t?.name==="class"&&t.options?(r.type="string",r.enum=t.options):(r.type=Sa(t?.name??"string"),t?.name==="string"||t?.name==="code"||t?.name==="url"||t?.name==="date"||t?.name==="datetime"?(t.minLength!==void 0&&(r.minLength=t.minLength),t.maxLength!==void 0&&(r.maxLength=t.maxLength),t.pattern!==void 0&&(r.pattern=t.pattern),t.format!==void 0&&(r.format=t.format),t.name==="url"&&!t.format&&(r.format="uri"),t.name==="date"&&!t.format&&(r.format="date"),t.name==="datetime"&&!t.format&&(r.format="date-time")):t?.name==="number"&&(t.minimum!==void 0&&(r.minimum=t.minimum),t.maximum!==void 0&&(r.maximum=t.maximum)));return r}function Sa(i){switch(i){case"string":case"code":case"url":case"date":case"datetime":case"image":case"audio":case"file":return"string";case"number":return"number";case"boolean":return"boolean";case"json":case"object":return["object","array","string","number","boolean","null"];default:return"string"}}function Kr(i){if(!i||typeof i!="object")throw new Error("Schema must be an object");if(i.type==="array"){if(!i.items)throw new Error('Array schema is missing an "items" definition (required by JSON Schema and all LLM providers for function tools)');Kr(i.items)}else if(i.type==="object"&&i.properties)for(let e of Object.values(i.properties))Kr(e)}var yt=class extends Error{calls;constructor(e){super(`Stop function executed: ${e.map(t=>t.func.name).join(", ")}`),this.name="AxStopFunctionCallException",this.calls=e}},Dn=class extends Error{constructor(t){super();this.fields=t;this.name="AxFunctionError"}getFields=()=>this.fields;toString(){return[`${this.name}: Function validation error`,...this.fields.map(t=>`  - ${t.field}: ${t.message}`)].join(`
`)}[Symbol.for("nodejs.util.inspect.custom")](t,n){return this.toString()}},$n=class extends Error{constructor(t,n,r){super();this.fields=t;this.func=n;this.funcId=r}getFunctionId=()=>this.funcId;getFieldDescription(t){if(!this.func.parameters?.properties?.[t])return"";let n=this.func.parameters.properties[t],r=n.description;return n.enum?.length&&(r+=` Allowed values are: ${n.enum.join(", ")}`),r}getFixingInstructions=()=>{let t=this.fields.map(n=>{let r=this.getFieldDescription(n.field)||"";return`- \`${n.field}\` - ${n.message} (${r}).`});return`Errors In Function Arguments: Fix the following invalid arguments to '${this.func.name}'
${t.join(`
...
- Do not use code blocks.`,bt=class{sig;fieldTemplates;task;thoughtFieldName;functions;cacheSystemPrompt;constructor(e,t,n){this.sig=e,this.fieldTemplates=n,this.thoughtFieldName=t?.thoughtFieldName??"thought",this.functions=t?.functions,this.cacheSystemPrompt=t?.cacheSystemPrompt;let r=[],o=Wa(this.sig.getInputFields()),s=Wa(this.sig.getOutputFields());r.push(`You will be provided with the following fields: ${o}. Your task is to generate new fields: ${s}.`);let l=this.functions?.map(m=>"toFunction"in m?m.toFunction():m)?.flat()?.map(m=>`- \`${m.name}\`: ${no(m.description)}`).join(`
`);l&&l.length>0&&r.push(`## Available Functions
${l}`);let c=bc(this.sig.getInputFields());r.push(`## Input Fields
${c}`);let u=Ic(this.sig.getOutputFields());r.push(`## Output Fields
${u}`),l&&l.length>0&&r.push(xc.trim()),this.sig.getOutputFields().some(m=>m.type?.name==="object"||m.type?.isArray&&m.type.fields)||r.push(yc.trim());let d=this.sig.getDescription();if(d){let m=no(d);r.push(m)}this.task={type:"text",text:r.join(`
...
`}),t};renderInField=(e,t,n)=>{let r=t[e.name];if(Cc(e,r,n))return;e.type&&Qr(e,r);let o=Tc(e,r);return(this.fieldTemplates?.[e.name]??this.defaultRenderInField)(e,o)};defaultRenderInField=(e,t)=>{if(e.type?.name==="image"){let r=s=>{if(!s)throw new Error("Image field value is required.");if(typeof s!="object")throw new Error("Image field value must be an object.");if(!("mimeType"in s))throw new Error("Image field must have mimeType");if(!("data"in s))throw new Error("Image field must have data");return s},o=[{type:"text",text:`${e.title}: `}];if(e.type.isArray){if(!Array.isArray(t))throw new Error("Image field value must be an array.");o=o.concat(t.map(s=>{let a=r(s);return{type:"image",mimeType:a.mimeType,image:a.data}}))}else{let s=r(t);o.push({type:"image",mimeType:s.mimeType,image:s.data})}return o}if(e.type?.name==="audio"){let r=s=>{if(!s)throw new Error("Audio field value is required.");if(typeof s!="object")throw new Error("Audio field value must be an object.");if(!("data"in s))throw new Error("Audio field must have data");return s},o=[{type:"text",text:`${e.title}: `}];if(e.type.isArray){if(!Array.isArray(t))throw new Error("Audio field value must be an array.");o=o.concat(t.map(s=>{let a=r(s);return{type:"audio",format:a.format??"wav",data:a.data}}))}else{let s=r(t);o.push({type:"audio",format:s.format??"wav",data:s.data})}return o}if(e.type?.name==="file"){let r=s=>{if(!s)throw new Error("File field value is required.");if(typeof s!="object")throw new Error("File field value must be an object.");if(!("mimeType"in s))throw new Error("File field must have mimeType");let a="data"in s,l="fileUri"in s;if(!a&&!l)throw new Error("File field must have either data or fileUri");if(a&&l)throw new Error("File field cannot have both data and fileUri");return s},o=[{type:"text",text:`${e.title}: `}];if(e.type.isArray){if(!Array.isArray(t))throw new Error("File field value must be an array.");o=o.concat(t.map(s=>{let a=r(s);return"fileUri"in a?{type:"file",mimeType:a.mimeType,fileUri:a.fileUri}:{type:"file",mimeType:a.mimeType,data:a.data}}))}else{let s=r(t);o.push("fileUri"in s?{type:"file",mimeType:s.mimeType,fileUri:s.fileUri}:{type:"file",mimeType:s.mimeType,data:s.data})}return o}if(e.type?.name==="url"){let r=s=>{if(!s)throw new Error("URL field value is required.");if(typeof s=="string")return{url:s};if(typeof s!="object")throw new Error("URL field value must be a string or object.");if(!("url"in s))throw new Error("URL field must have url property");return s},o=[{type:"text",text:`${e.title}: `}];if(e.type.isArray){if(!Array.isArray(t))throw new Error("URL field value must be an array.");o=o.concat(t.map(s=>{let a=r(s);return{type:"url",url:a.url,...a.title?{title:a.title}:{},...a.description?{description:a.description}:{}}}))}else{let s=r(t);o.push({type:"url",url:s.url,...s.title?{title:s.title}:{},...s.description?{description:s.description}:{}})}return o}let n=[e.title,": "];return Array.isArray(t)?(n.push(`
`),n.push(t.map(r=>`- ${r}`).join(`
`))):n.push(t),[{type:"text",text:n.join("")}]}},Wa=i=>i.map(e=>`\`${e.title}\``).join(", "),bc=i=>i.map(t=>{let n=t.title,r=t.type?.name?Ja(t.type):"string",o=t.isOptional?`This optional ${r} field may be omitted`:`A ${r} field`,s=t.description?` ${no(t.description)}`:"";return`${n}: (${o})${s}`.trim()}).join(`
`),Ic=i=>i.map(t=>{let n=t.title,r=t.type?.name?Ja(t.type):"string",o=t.isOptional?`Only include this ${r} field if its value is available`:`This ${r} field must be included`,s="";return t.description&&t.description.length>0&&(s=` ${t.type?.name==="class"?t.description:no(t.description)}`),t.type?.options&&t.type.options.length>0&&(s.length>0&&(s+=". "),s+=`Allowed values: ${t.type.options.join(", ")}`),`${n}: (${o})${s}`.trim()}).join(`
`),Tc=(i,e)=>{if(i.type?.name==="date"&&e instanceof Date){let t=e.toISOString();return t.slice(0,t.indexOf("T"))}return i.type?.name==="datetime"&&e instanceof Date?_a(e):i.type?.name==="image"&&typeof e=="object"||i.type?.name==="audio"&&typeof e=="object"||i.type?.name==="file"&&typeof e=="object"||i.type?.name==="url"&&(typeof e=="string"||typeof e=="object")||typeof e=="string"?e:JSON.stringify(e,null,2)},Ja=i=>{let e=(()=>{switch(i?.name){case"string":return"string";case"number":return"number";case"boolean":return"boolean (true or false)";case"date":return'date ("YYYY-MM-DD" format)';case"datetime":return'date time ("YYYY-MM-DD HH:mm Timezone" format)';case"json":return"JSON object";case"class":return"classification class";case"code":return"code";case"file":return"file (with filename, mimeType, and data)";case"url":return"URL (string or object with url, title, description)";case"object":return"object";default:return"string"}})();return i?.isArray?`json array of ${e} items`:e};function Va(i){return(e,t)=>{if(t.type==="text"){let n=e.length>0?e[e.length-1]:null;n&&n.type==="text"?n.text+=i+t.text:e.push(t)}else e.push(t);return e}}var Cc=(i,e,t)=>{if(typeof e=="boolean"||i?.type?.name==="number"&&typeof e=="number")return!1;if(!e||(Array.isArray(e)||typeof e=="string")&&e.length===0){if(t?.isExample||i.isOptional||i.isInternal)return!0;let n=t?.isInputField!==!1?"input":"output";throw new Error(`Value for ${n} field '${i.name}' is required.`)}return!1};function no(i){let e=i.trim();return e.length>0?`${e.charAt(0).toUpperCase()}${e.slice(1)}${e.endsWith(".")?"":"."}`:""}function Rc(i,e){let t=i.history(0,e),n=t.some(o=>o.role==="function");return t.some(o=>o.role==="assistant"&&"functionCalls"in o&&Array.isArray(o.functionCalls)&&o.functionCalls.length>0)&&n}function wc(i,e){let t=i.history(0,e),n=[],r=t.filter(s=>s.role==="assistant"&&"functionCalls"in s&&Array.isArray(s.functionCalls)&&s.functionCalls.length>0),o=t.filter(s=>s.role==="function");for(let s of r)if("functionCalls"in s&&s.functionCalls)for(let a of s.functionCalls){let l=o.find(c=>"functionId"in c&&c.functionId===a.id);l&&"result"in l&&"functionId"in l&&n.push({index:n.length,functionName:a.function.name,functionId:a.id,args:a.function.params||"",result:String(l.result),isError:"isError"in l?!!l.isError:!1})}return n}async function ro(i,e,t,n){if(!e?.resultPicker||i.length<=1)return 0;let r=e.resultPicker;if((t?Rc(t,n):!1)&&t){let l=wc(t,n),c=await r({type:"function",results:l});if(c<0||c>=l.length)throw new Error(`Result picker returned invalid index: ${c}. Must be between 0 and ${l.length-1}`);return c}let s=i.map((l,c)=>({index:c,sample:l.delta})),a=await r({type:"fields",results:s});if(a<0||a>=i.length)throw new Error(`Result picker returned invalid index: ${a}. Must be between 0 and ${i.length-1}`);return a}async function Qa(i,e,t){let n=i?.getLast(e);if(!n||n.role!=="assistant"||n.chat.length<=1)return 0;let r=n.chat.map(s=>({version:0,index:s.index,delta:s.value}));return await ro(r,t,i,e)}var oo=class{tools;logger;constructor(e,t){this.tools=new Map(e.map(n=>[n.name,n])),this.logger=t}getToolParamFieldMap(){let e=new Map;for(let[,t]of this.tools.entries())if(t.parameters?.properties&&Object.keys(t.parameters.properties).length>0){let{paramFieldMap:n}=Sc(t);e.set(t.name,n)}else e.set(t.name,new Map);return e}async route(e,t){let n=[],r={},o=new Map,s=new Map;for(let[a,l]of this.tools.entries())s.set(a,this.buildSanitizedFieldMap(l));for(let[a,l]of Object.entries(e)){let c=this.tools.get(this.normalizeToolName(a));if(c){l!=null&&typeof l=="object"&&o.set(c.name,l);continue}r[a]=l}for(let[a,l]of Object.entries(e))for(let[c,u]of this.tools.entries()){let p=s.get(c);if(!p)continue;let d=p.get(a);if(!d)continue;let m=o.get(u.name)??{};this.setNested(m,d,l),o.set(u.name,m)}for(let[a,l]of this.tools.entries()){let c=o.get(l.name);if(!(!c||Object.keys(c).length===0)){if(l.parameters&&l.parameters.type==="object"){let p=(l.parameters.required||[]).filter(d=>c[d]===void 0);if(p.length>0)throw new he(`Missing required arguments for tool '${l.name}': ${p.join(", ")}`)}n.push({id:l.name,name:l.name,args:JSON.stringify(c)})}}return{functionCalls:n,remainingFields:r}}normalizeToolName(e){return e.replace(/_([a-z])/g,(t,n)=>n.toUpperCase())}sanitizeFieldName(e){return e.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_|_$/g,"").replace(/[^a-z0-9_]/g,"_")}buildSanitizedFieldMap(e){let t=new Map;if(!e.parameters||!("properties"in e.parameters))return t;let n=(r,o)=>{for(let[s,a]of Object.entries(r)){let l=[...o,s];if(a&&a.type==="object"&&a.properties)n(a.properties,l);else{let c=`${e.name}.${l.join(".")}`,u=this.sanitizeFieldName(c);t.set(u,l)}}};return n(e.parameters.properties??{},[]),t}setNested(e,t,n){let r=e;for(let o=0;o<t.length-1;o++){let s=t[o],a=r[s];(typeof a!="object"||a===null)&&(r[s]={}),r=r[s]}r[t[t.length-1]]=n}isToolField(e){return this.tools.has(this.normalizeToolName(e))}getToolFieldNames(){return Array.from(this.tools.keys()).map(e=>e.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_/,""))}};function Sc(i){let e=[],t=new Map;if(!i.parameters||!i.parameters.properties)return{fields:e,paramFieldMap:t};let n=i.parameters.properties,r=i.parameters.required||[],o=(s,a,l)=>{for(let[c,u]of Object.entries(s)){let p=a?`${a}.${c}`:c,d=`${i.name}.${p}`;if(u.type==="object"&&u.properties)o(u.properties,p,u.required||[]);else{let m=vc(u);e.push({name:Oc(d),title:kc(i.name,p),type:m,description:u.description||`${c} parameter for ${i.name}`,isOptional:!0}),t.set(d,e[e.length-1])}}};return o(n,"",r),{fields:e,paramFieldMap:t}}function vc(i){switch(i.type){case"string":return{name:"string",isArray:!1};case"number":case"integer":return{name:"number",isArray:!1};case"boolean":return{name:"boolean",isArray:!1};case"array":{let e=i.items;if(e?.type)switch(e.type){case"string":return{name:"string",isArray:!0};case"number":case"integer":return{name:"number",isArray:!0};case"boolean":return{name:"boolean",isArray:!0};default:return{name:"json",isArray:!0}}return{name:"json",isArray:!0}}case"object":return{name:"json",isArray:!1};default:return{name:"string",isArray:!1}}}function kc(i,e){return`${i} ${e.replace(/\./g," ")}`}function Oc(i){return i.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_|_$/g,"").replace(/[^a-z0-9_]/g,"_")}function Za(i,e,t){let n=new ce(e);if(t){let r=t.getToolParamFieldMap();for(let o of i){let s=r.get(o.name);if(s&&s.size>0)for(let a of s.values())n.getOutputFields().some(c=>c.name===a.name)||n.addOutputField(a);else{let a=Ls(o.name),l=Xa(o.parameters);n.getOutputFields().some(u=>u.name===a)||n.addOutputField({name:a,title:Ya(o.name),type:l,description:o.description||`Parameters for ${o.name}`,isOptional:!0})}}return{signature:n,toolParamFieldMap:r}}else{let r=new Map;for(let o of i)if(o.parameters?.properties&&Object.keys(o.parameters.properties).length>0){let{fields:s,paramFieldMap:a}=Mc(o);r.set(o.name,a);for(let l of s)n.getOutputFields().some(u=>u.name===l.name)||n.addOutputField(l)}else{let s=Ls(o.name),a=Xa(o.parameters);n.getOutputFields().some(c=>c.name===s)||n.addOutputField({name:s,title:Ya(o.name),type:a,description:o.description||`Parameters for ${o.name}`,isOptional:!0})}return{signature:n,toolParamFieldMap:r}}}function Mc(i){let e=[],t=new Map;if(!i.parameters||!i.parameters.properties)return{fields:e,paramFieldMap:t};let n=i.parameters.properties,r=i.parameters.required||[],o=(s,a,l)=>{for(let[c,u]of Object.entries(s)){let p=a?`${a}.${c}`:c,d=`${i.name}.${p}`;if(u.type==="object"&&u.properties)o(u.properties,p,u.required||[]);else{let m=Ec(u),h={name:Ls(d),title:Pc(i.name,p),type:m,description:u.description||`${c} parameter for ${i.name}`,isOptional:!0};e.push(h),t.set(d,h)}}};return o(n,"",r),{fields:e,paramFieldMap:t}}function Ec(i){switch(i.type){case"string":return{name:"string",isArray:!1};case"number":case"integer":return{name:"number",isArray:!1};case"boolean":return{name:"boolean",isArray:!1};case"array":{let e=i.items;if(e?.type)switch(e.type){case"string":return{name:"string",isArray:!0};case"number":case"integer":return{name:"number",isArray:!0};case"boolean":return{name:"boolean",isArray:!0};default:return{name:"json",isArray:!0}}return{name:"json",isArray:!0}}case"object":return{name:"json",isArray:!1};default:return{name:"string",isArray:!1}}}function Pc(i,e){return`${i} ${e.replace(/\./g," ")}`}function Ls(i){return i.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/^_|_$/g,"").replace(/[^a-z0-9_]/g,"_")}function Ya(i){return i.replace(/([A-Z])/g," $1").replace(/^./,e=>e.toUpperCase()).trim()}function Xa(i){return!i||!i.properties||Object.keys(i.properties).length===0?{name:"string",isArray:!1}:{name:"json",isArray:!1}}var Bn=class{tools;router;injectedToolFieldNames=new Set;constructor(e){this.tools=e,this.router=new oo(e)}processSignature(e){let{signature:t}=Za(this.tools,e),n=new Set(t.getOutputFields().map(o=>o.name)),r=new Set(e.getOutputFields().map(o=>o.name));return this.injectedToolFieldNames=new Set([...n].filter(o=>!r.has(o))),t}async processResults(e,t){let{functionCalls:n}=await this.router.route(e,t);return n.length>0?n:void 0}getInjectedToolFieldNames(){return Array.from(this.injectedToolFieldNames)}getRouter(){return this.router}};var we=class extends ut{promptTemplate;asserts;streamingAsserts;options;functions;fieldProcessors=[];streamingFieldProcessors=[];excludeContentFromTrace=!1;thoughtFieldName;signatureToolCallingManager;constructor(e,t){super(e,{description:t?.description,traceLabel:t?.traceLabel}),this.options=t,this.thoughtFieldName=t?.thoughtFieldName??"thought";let n={functions:t?.functions,thoughtFieldName:this.thoughtFieldName,cacheSystemPrompt:t?.cacheSystemPrompt};this.promptTemplate=new(t?.promptTemplate??bt)(this.signature,n),this.asserts=this.options?.asserts??[],this.streamingAsserts=this.options?.streamingAsserts??[],this.excludeContentFromTrace=t?.excludeContentFromTrace??!1,this.functions=t?.functions?Vr(t.functions):[],this.usage=[]}getSignatureName(){return this.signature.getDescription()||"unknown_signature"}getMetricsInstruments(){return Is()}updateMeter(e){Is(e)}createStates(e){return Array.from({length:e},(t,n)=>({index:n,functionCalls:[],values:{},content:"",functionsExecuted:new Set,xstate:{extractedFields:[],streamedIndex:{},s:-1}}))}addAssert=(e,t)=>{this.asserts.push({fn:e,message:t})};addStreamingAssert=(e,t,n)=>{let r=this.signature.getOutputFields().find(a=>a.name===e);if(!r)throw new Error(`addStreamingAssert: field ${String(e)} not found in output signature`);let o=r.type?.name;if(!(!o||o==="string"||o==="code"))throw new Error(`addStreamingAssert: field ${String(e)} must be a string field for streaming assertions`);this.streamingAsserts.push({fieldName:String(e),fn:t,message:n})};addFieldProcessorInternal=(e,t,n=!1)=>{let r=this.signature.getOutputFields().find(o=>o.name===e);if(!r)throw new Error(`addFieldProcessor: field ${e} not found`);if(n){let o=r.type?.name;if(!(!o||o==="string"||o==="code"))throw new Error(`addFieldProcessor: field ${e} must be a text field`);this.streamingFieldProcessors.push({field:r,process:t})}else this.fieldProcessors.push({field:r,process:t})};addStreamingFieldProcessor=(e,t)=>{this.addFieldProcessorInternal(String(e),t,!0)};addFieldProcessor=(e,t)=>{this.addFieldProcessorInternal(String(e),t,!1)};async forwardSendRequest({ai:e,mem:t,options:n,traceContext:r,functions:o,functionCall:s,stepIndex:a}){let{sessionId:l,model:c,rateLimiter:u,stream:p,thinkingTokenBudget:d,showThoughts:m}=n??{},h=await Qa(t,l,{resultPicker:n?.resultPicker}),A=t?.history(h,l)??[];if(A.length===0)throw new Error("No chat prompt found");let g={...n?.modelConfig,...n?.sampleCount?{n:n.sampleCount}:{},...n?.sampleCount&&n?.modelConfig?.temperature===1?{temperature:.8}:{}},f=this.isDebug(e,n),x=a===0,b=this.getLogger(e,n);o=this.signatureToolCallingManager?[]:o;let I,S=this.signature.getOutputFields();return S.some(y=>y.type?.name==="object"||y.type?.isArray&&y.type.fields)&&(I={type:"json_schema",schema:{name:"output",strict:!0,schema:Wr(S)}}),await e.chat({chatPrompt:A,functions:o,functionCall:s,modelConfig:g,model:c,responseFormat:I},{sessionId:l,rateLimiter:u,stream:p,debug:f,debugHideSystemPrompt:!x,thinkingTokenBudget:d,showThoughts:m,traceContext:r,abortSignal:n?.abortSignal??Q.abortSignal,stepIndex:a,logger:b,functionCallMode:n?.functionCallMode??this.options?.functionCallMode??"auto"})}async*forwardCore({ai:e,mem:t,options:n,stepIndex:r,span:o,traceContext:s,states:a,stopFunctionNames:l}){let{sessionId:c,functions:u}=n??{},p=n?.functionResultFormatter??this.options?.functionResultFormatter,d=n?.functionCall??this.options?.functionCall,m=this.signatureToolCallingManager,h=n?.strictMode??!1,A=n.model,g=this.usage,f=r===0,x=this.isDebug(e,n),b=this.getLogger(e,n),{functions:I,functionCall:S}=va(u,d,f,n),T=await this.forwardSendRequest({ai:e,mem:t,options:n,traceContext:s,functions:I,functionCall:S,stepIndex:r});T instanceof ReadableStream?yield*Ba({ai:e,model:A,res:T,mem:t,sessionId:c,traceId:o?o.spanContext?.().traceId:void 0,functions:I,strictMode:h,span:o,states:a,usage:g,asserts:this.asserts,streamingAsserts:this.streamingAsserts,fieldProcessors:this.fieldProcessors,streamingFieldProcessors:this.streamingFieldProcessors,thoughtFieldName:this.thoughtFieldName,excludeContentFromTrace:this.excludeContentFromTrace,signature:this.signature,logger:b,debug:x,functionResultFormatter:p,signatureToolCallingManager:m,stopFunctionNames:l,disableMemoryCleanup:n.disableMemoryCleanup}):yield*ja({ai:e,model:A,res:T,mem:t,sessionId:c,traceId:o?o.spanContext?.().traceId:void 0,functions:I,span:o,strictMode:h,states:a,usage:g,asserts:this.asserts,fieldProcessors:this.fieldProcessors,thoughtFieldName:this.thoughtFieldName,excludeContentFromTrace:this.excludeContentFromTrace,signature:this.signature,logger:b,debug:x,functionResultFormatter:p,signatureToolCallingManager:m,stopFunctionNames:l,disableMemoryCleanup:n.disableMemoryCleanup})}async*_forward2(e,t,n,r,o,s){let a=r?.stopFunction??this.options?.stopFunction,l=Array.isArray(a)?a.map(E=>E.toLowerCase()):a?[a.toLowerCase()]:void 0,c=r.maxRetries??this.options?.maxRetries??10,u=r.maxSteps??this.options?.maxSteps??10,p=r.mem??this.options?.mem??new Xt,d=[...this.functions,...r.functions?Vr(r.functions):[]],m=d&&d.length>0,h=r.functionCallMode??this.options?.functionCallMode??"auto",A=r.cacheSystemPrompt??this.options?.cacheSystemPrompt;m&&h==="prompt"&&(this.signatureToolCallingManager=new Bn(d)),m&&h==="auto"&&!e.getFeatures(r.model).functions&&(this.signatureToolCallingManager=new Bn(d));let g,f,x=this.options?.promptTemplate??bt;this.signatureToolCallingManager&&(this.signature=this.signatureToolCallingManager.processSignature(this.signature),this.setSignature(this.signature));let b={functions:this.signatureToolCallingManager?[]:d,thoughtFieldName:this.thoughtFieldName,cacheSystemPrompt:A};this.promptTemplate=new x(this.signature,b);let I,S=performance.now();Array.isArray(t)?(Pi(t),I=this.promptTemplate.render(t,{examples:this.examples,demos:this.demos})):I=this.promptTemplate.render(t,{examples:this.examples,demos:this.demos});let T=performance.now()-S,w=this.getMetricsInstruments();w&&jr(w,"prompt_render",T,this.getSignatureName());let y=performance.now();p.addRequest(I,r.sessionId);let k=performance.now()-y;w&&jr(w,"memory_update",k,this.getSignatureName());e:for(let E=0;E<u;E++){for(let R=0;R<c;R++)try{let P=this.forwardCore({options:r,ai:e,mem:p,stepIndex:E,span:o,traceContext:s,states:n,stopFunctionNames:l}),C=!1;try{for await(let $ of P)$!==void 0&&(yield{version:R,index:$.index,delta:$.delta})}catch($){if($ instanceof yt)C=!0;else throw $}if(C?!1:qa(p,l,n,r?.sessionId)){let $=this.getMetricsInstruments();$&&Br($,E+1,u,this.getSignatureName());continue e}r?.disableMemoryCleanup||(p.removeByTag("invalid-assistant",r.sessionId),p.removeByTag("correction",r.sessionId),p.removeByTag("error",r.sessionId));let O=this.getMetricsInstruments();if(O){Br(O,E+1,u,this.getSignatureName());let $=new Set;n.forEach(Y=>{Y.functionsExecuted.forEach(W=>$.add(W))}),$.size>0&&pa(O,!0,$.size,!0,!1,this.getSignatureName()),da(O,this.fieldProcessors.length,this.streamingFieldProcessors.length,this.getSignatureName())}return}catch(P){f=P;let C,v=this.isDebug(e,r),O=this.getLogger(e,r),$=this.getMetricsInstruments(),Y=this.getSignatureName(),W={error:P,errCount:R,logger:O,metricsInstruments:$,signatureName:Y,span:o,debug:v};if(o?.recordException(P),P instanceof he)C=Ta(W),g=P;else if(P instanceof Ve)C=Ca(W),g=P;else if(P instanceof ae)Ra(W);else if(!(P instanceof Be))throw Gs(P,e,this.signature);C&&(p.addTag("error",r.sessionId),p.addRequest([{role:"user",content:this.promptTemplate.renderExtraFields(C)}],r.sessionId),p.addTag("correction",r.sessionId))}let M=this.getMetricsInstruments();throw M&&Cs(M,c,!1,c,this.getSignatureName()),Gs(new Error(`Unable to fix validation error: ${(g??f)?.message??(g??f)?.toString()??"unknown error"}`),e,this.signature)}throw w&&Br(w,u,u,this.getSignatureName()),Gs(new Error(`Max steps reached: ${u}`),e,this.signature)}validateInputs(e){let t=this.signature.getInputFields();for(let n of t){if(n.isInternal)continue;let r=e[n.name];if(n.isOptional&&r===void 0)continue;let o=n.type;if(o&&(o.name==="url"&&ct(r,n),o.name,o.name,(o.name==="string"||o.name==="code")&&_e(r,n),o.name==="number"&&Ne(r,n),o.name==="object"&&o.fields&&typeof r=="object"&&r!==null&&this.validateObjectFields(r,o.fields,n.name),o.isArray&&Array.isArray(r)))for(let s=0;s<r.length;s++){let a=r[s];o.name==="string"||o.name==="code"?_e(a,n):o.name==="number"?Ne(a,n):o.fields&&typeof a=="object"&&a!==null&&this.validateObjectFields(a,o.fields,`${n.name}[${s}]`)}}}validateObjectFields(e,t,n){for(let[r,o]of Object.entries(t)){let s=e[r];if(o.isOptional&&s===void 0)continue;let a={name:`${n}.${r}`,type:{name:o.type,isArray:o.isArray,options:o.options?[...o.options]:void 0,fields:o.fields,minLength:o.minLength,maxLength:o.maxLength,minimum:o.minimum,maximum:o.maximum,pattern:o.pattern,format:o.format},description:o.description,isOptional:o.isOptional};if(o.type==="string"||o.type==="code"?_e(s,a):o.type==="number"?Ne(s,a):o.type==="object"&&o.fields&&typeof s=="object"&&s!==null&&this.validateObjectFields(s,o.fields,a.name),o.isArray&&Array.isArray(s))for(let l=0;l<s.length;l++){let c=s[l];o.type==="string"||o.type==="code"?_e(c,a):o.type==="number"?Ne(c,a):o.fields&&typeof c=="object"&&c!==null&&this.validateObjectFields(c,o.fields,`${a.name}[${l}]`)}}}async*_forward1(e,t,n){(!Array.isArray(t)||!t.every(f=>"role"in f))&&this.validateInputs(t);let r=performance.now(),o=this.createStates(n.sampleCount??1),s=performance.now()-r,a=this.getMetricsInstruments();a&&jr(a,"state_creation",s,this.getSignatureName());let l=n?.tracer??this.options?.tracer??e.getOptions().tracer,c=this.functions;if(n?.functions&&(c=Vr(n.functions,this.functions)),!l){yield*this._forward2(e,t,o,{...n,functions:c});return}let u=c?.map(f=>f.name).join(","),p={signature:JSON.stringify(this.signature.toJSON(),null,2),...this.examples?{examples:JSON.stringify(this.examples,null,2)}:{},...u?{provided_functions:u}:{},...n?.model?{model:n.model}:{},...n?.thinkingTokenBudget?{thinking_token_budget:n.thinkingTokenBudget}:{},...n?.showThoughts?{show_thoughts:n.showThoughts}:{},...n?.maxSteps?{max_steps:n.maxSteps}:{},...n?.maxRetries?{max_retries:n.maxRetries}:{}},d=this.traceLabel&&n.traceLabel?`${this.traceLabel} > ${n.traceLabel}`:n.traceLabel??this.traceLabel,m=d?`AxGen > ${d}`:"AxGen",h=l.startSpan(m,{kind:nn.SpanKind.SERVER,attributes:p}),A=nn.context.active(),g=nn.trace.setSpan(A,h);try{if(this.excludeContentFromTrace||h.addEvent("input",{content:JSON.stringify(t,null,2)}),yield*this._forward2(e,t,o,{...n,functions:c},h,g),!this.excludeContentFromTrace){let f=o.map(b=>b.values),x=f.length===1?f[0]:f;h.addEvent("output",{content:JSON.stringify(x,null,2)})}}finally{h.end()}}async forward(e,t,n){let r=n?.cachingFunction??this.options?.cachingFunction??Q.cachingFunction,o=(()=>{if(!r)return;let d=this.signature.getInputFields().map(m=>m.name);return this.computeCacheKey(t,d)})();if(r&&o){let d=await r(o);if(d!==void 0)return d}let s=performance.now(),a=this.getSignatureName(),l=n?.stream??!1,c=!1,u=0,p=!1;try{let d=this.getMetricsInstruments();d&&ha(d,this.signature.getInputFields().length,this.signature.getOutputFields().length,this.examples?.length??0,this.demos?.length??0,a);let m=this._forward1(e,t,n??{}),h=[],A=0,g=0;for await(let w of m)w.version!==A&&(h=[]),A=w.version,h=ks(h,w),g++;u=A;let f=performance.now();p=!!n?.resultPicker;let x=await ro(h,{resultPicker:n?.resultPicker},n?.mem,n?.sessionId),b=performance.now()-f,S=h[x]?.delta??{},T=Array.isArray(t)?{}:t??{};if(this.trace={...T,...S},p&&this.isDebug(e,n)){let w=this.getLogger(e,n);gi(h.length,x,b,w)}if(c=!0,d&&(ga(d,h.length,p,p?b:void 0,a),ma(d,l,g,void 0,a)),r&&o)try{await r(o,S)}catch{}return S}catch(d){throw c=!1,d}finally{let d=performance.now()-s,m=this.getMetricsInstruments();m&&(ca(m,d,c,a,e.getName(),n?.model?String(n.model):void 0),u>0&&Cs(m,u,c,n?.maxRetries??10,a))}}async*streamingForward(e,t,n){let r=n?.cachingFunction??this.options?.cachingFunction??Q.cachingFunction,o=(()=>{if(!r)return;let p=this.signature.getInputFields().map(d=>d.name);return this.computeCacheKey(t,p)})();if(r&&o){let p;try{p=await r(o)}catch{}if(p!==void 0){yield{version:0,index:0,delta:p};return}}if(!n?.resultPicker){yield*this._forward1(e,t,{...n,stream:!0});return}let s=this._forward1(e,t,{...n,stream:!0}),a=[],l=0;for await(let p of s)p.version!==l&&(a=[]),l=p.version,a=ks(a,p);let c=await ro(a,{resultPicker:n?.resultPicker},n?.mem,n?.sessionId),u=a[c];if(u){if(r&&o)try{await r(o,u.delta)}catch{}yield{version:l,index:c,delta:u.delta}}}setExamples(e,t){super.setExamples(e,t)}isDebug(e,t){return t?.debug??this.options?.debug??e.getOptions().debug??!1}getLogger(e,t){return t?.logger??this.options?.logger??Q.logger??e.getLogger()}computeCacheKey(e,t){let n=Ee("sha256");n.update(this.signature.hash()??"");let r=o=>{let s=typeof o;if(n.update(`|${s}|`),o==null){n.update("null");return}if(s==="string"||s==="number"||s==="boolean"){n.update(String(o));return}if(Array.isArray(o)){n.update("[");for(let a of o)r(a);n.update("]");return}if(typeof o=="object"&&o!==null&&"mimeType"in o&&"data"in o){let a=o;n.update(a.mimeType??"");let l=Ee("sha256").update(a.data??"").digest("hex");n.update(l);return}if(typeof o=="object"){let a=o,l=Object.keys(a).sort();for(let c of l)n.update(`{${c}}`),r(a[c]);return}n.update(String(o))};if(Array.isArray(e))for(let o of e){n.update(`role:${o.role}`);let s=t.map(a=>o.values?.[a]);for(let a of s)r(a)}else{let o=t.map(s=>e?.[s]);for(let s of o)r(s)}return n.digest("hex")}},jn=class extends Error{details;constructor(e,t,n){super(e),this.name="AxGenerateError",this.details=t,n?.cause&&(this.cause=n.cause)}};function Gs(i,e,t){let n=i instanceof Error?i:new Error(String(i)),r=(n.message||"").toLowerCase();if(r.includes("at least")||r.includes("at most")||r.includes("must match pattern")||r.includes("invalid url")||r.includes("required")||r.includes("missing")||r.includes("valid email")||r.includes("number must be")||n.name==="ValidationError"||n.name==="AssertionError"||n.name==="AxAssertionError"||n.stack?.includes("asserts.ts"))return n;let s=e.getLastUsedChatModel(),a=e.getLastUsedModelConfig(),l={model:s,maxTokens:a?.maxTokens,streaming:a?.stream??!1,signature:{input:t.getInputFields(),output:t.getOutputFields(),description:t.getDescription()}};return new jn("Generate failed",l,{cause:n})}var Fc=i=>i.replace(/^\W+|\W+$/g,""),_c=(i,e)=>{let t=i.search(e);if(t===-1)return[i];let n=i.match(e);if(!n)throw new Error("Match failed unexpectedly.");let r=i.substring(0,t),o=i.substring(t+n[0].length);return[r,o]},Nc=i=>{let e=new Set,t=[];for(let n of i)e.has(n)||(e.add(n),t.push(n));return t},Dc=i=>{let e=i.match(/^(\d+)[.,\s]+(.*)$/);if(!e||e.length<3)throw new Error('line must start with a number, a dot and then text. e.g. "1. hello"');let t=Number.parseInt(e[1],10),n=e[2].trim();return{id:t,text:n}},$c=i=>{let e=i.match(/^(\d+)[.,\s]+(.*)$/);return e&&e[2]!==void 0?e[2].trim():i},Lc=(i,e)=>{let t=[];for(let n=0;n<i.length;n+=e)t.push(i.slice(n,n+e));return t},so={trimNonAlphaNum:Fc,splitIntoTwo:_c,dedup:Nc,extractIdAndText:Dc,extractIndexPrefixedText:$c,batchArray:Lc};var io=class extends we{constructor(e){super(`"You are a re-ranker assistant tasked with evaluating a set of content items in relation to a specific question. Your role involves critically analyzing each content item to determine its relevance to the question and re-ranking them accordingly. This process includes assigning a relevance score from 0 to 10 to each content item based on how well it answers the question, its coverage of the topic, and the reliability of its information. This re-ranked list should start with the content item that is most relevant to the question and end with the least relevant. Output only the list."
    query: string, items: string[] -> rankedItems: string[] "list of id, 5-words Rationale, relevance score"`,e)}forward=async(e,t,n)=>{let{rankedItems:r}=await super.forward(e,t,n),o=r.map(a=>{let{id:l}=so.extractIdAndText(a);return l});return{rankedItems:t.items.map((a,l)=>{let c=o[l];return c!==void 0?t.items[c]:void 0}).filter(a=>a!==void 0)}}};var ao=class{tikaUrl;fetch;constructor(e){let t=e??{url:"http://localhost:9998/"};this.tikaUrl=new URL("/tika",t.url),this.fetch=t.fetch}async _convert(e,t){if(!e)throw new Error("Failed to read file data");let n=t?.format==="html"?"text/html":"text/plain";try{let r={body:e,headers:{Accept:n},method:"PUT"};typeof window>"u"&&typeof process<"u"&&(r.duplex="half");let o=await(this.fetch??fetch)(this.tikaUrl,r);if(!o.ok)throw new Error(`Failed to upload file: ${o.statusText}`);return await o.text()}catch(r){throw new Error(`Error converting file: ${r}`)}}async convert(e,t){let n=[],r=t?.batchSize??10;for(let o=0;o<e.length;o+=r){let a=e.slice(o,o+r).map(c=>this._convert(c,{format:t?.format})),l=await Promise.all(a);n.push(...l)}return n}};var Rh=new Ce,lo=class{name;context;constructor(e,t){this.name=e,this.context=t}getName(){return this.name}getContext(){return this.context}},co=class{ai;db;debug;constructor(e){this.db=new at,this.ai=e}getState(){return this.db.getDB()}setState(e){this.db.setDB(e)}setClasses=async(e,t)=>{for(let n of e){let r=await this.ai.embed({texts:n.getContext()},{abortSignal:t?.abortSignal});await this.db.upsert({id:n.getName(),table:"classes",values:r.embeddings[0]})}};async forward(e,t){let{embeddings:n}=await this.ai.embed({texts:[e]},{abortSignal:t?.abortSignal}),o=(await this.db.query({table:"classes",values:n[0]})).matches;if(typeof t?.cutoff=="number"){let{cutoff:a}=t;o=o.filter(l=>l.score<=a)}let s=o.at(0);return s?s.id:""}setOptions(e){typeof e.debug=="boolean"&&(this.debug=e.debug)}};var el=new Set(["0o","0s","3a","3b","3d","6b","6o","a","a1","a2","a3","a4","ab","able","about","above","abst","ac","accordance","according","accordingly","across","act","actually","ad","added","adj","ae","af","affected","affecting","affects","after","afterwards","ag","again","against","ah","ain","ain't","aj","al","all","allow","allows","almost","alone","along","already","also","although","always","am","among","amongst","amoungst","amount","an","and","announce","another","any","anybody","anyhow","anymore","anyone","anything","anyway","anyways","anywhere","ao","ap","apart","apparently","appear","appreciate","appropriate","approximately","ar","are","aren","arent","aren't","arise","around","as","a's","aside","ask","asking","associated","at","au","auth","av","available","aw","away","awfully","ax","ay","az","b","b1","b2","b3","ba","back","bc","bd","be","became","because","become","becomes","becoming","been","before","beforehand","begin","beginning","beginnings","begins","behind","being","believe","below","beside","besides","best","better","between","beyond","bi","bill","biol","bj","bk","bl","bn","both","bottom","bp","br","brief","briefly","bs","bt","bu","but","bx","by","c","c1","c2","c3","ca","call","came","can","cannot","cant","can't","cause","causes","cc","cd","ce","certain","certainly","cf","cg","ch","changes","ci","cit","cj","cl","clearly","cm","c'mon","cn","co","com","come","comes","con","concerning","consequently","consider","considering","contain","containing","contains","corresponding","could","couldn","couldnt","couldn't","course","cp","cq","cr","cry","cs","c's","ct","cu","currently","cv","cx","cy","cz","d","d2","da","date","dc","dd","de","definitely","describe","described","despite","detail","df","di","did","didn","didn't","different","dj","dk","dl","do","does","doesn","doesn't","doing","don","done","don't","down","downwards","dp","dr","ds","dt","du","due","during","dx","dy","e","e2","e3","ea","each","ec","ed","edu","ee","ef","effect","eg","ei","eight","eighty","either","ej","el","eleven","else","elsewhere","em","empty","en","end","ending","enough","entirely","eo","ep","eq","er","es","especially","est","et","et-al","etc","eu","ev","even","ever","every","everybody","everyone","everything","everywhere","ex","exactly","example","except","ey","f","f2","fa","far","fc","few","ff","fi","fifteen","fifth","fify","fill","find","fire","first","five","fix","fj","fl","fn","fo","followed","following","follows","for","former","formerly","forth","forty","found","four","fr","from","front","ft","fu","full","further","furthermore","fy","g","ga","gave","ge","get","gets","getting","gi","give","given","gives","giving","gj","gl","go","goes","going","gone","got","gotten","gr","greetings","gs","gy","h","h2","h3","had","hadn","hadn't","happens","hardly","has","hasn","hasnt","hasn't","have","haven","haven't","having","he","hed","he'd","he'll","hello","help","hence","her","here","hereafter","hereby","herein","heres","here's","hereupon","hers","herself","hes","he's","hh","hi","hid","him","himself","his","hither","hj","ho","home","hopefully","how","howbeit","however","how's","hr","hs","http","hu","hundred","hy","i","i2","i3","i4","i6","i7","i8","ia","ib","ibid","ic","id","i'd","ie","if","ig","ignored","ih","ii","ij","il","i'll","im","i'm","immediate","immediately","importance","important","in","inasmuch","inc","indeed","index","indicate","indicated","indicates","information","inner","insofar","instead","interest","into","invention","inward","io","ip","iq","ir","is","isn","isn't","it","itd","it'd","it'll","its","it's","itself","iv","i've","ix","iy","iz","j","jj","jr","js","jt","ju","just","k","ke","keep","keeps","kept","kg","kj","km","know","known","knows","ko","l","l2","la","largely","last","lately","later","latter","latterly","lb","lc","le","least","les","less","lest","let","lets","let's","lf","like","liked","likely","line","little","lj","ll","ll","ln","lo","look","looking","looks","los","lr","ls","lt","ltd","m","m2","ma","made","mainly","make","makes","many","may","maybe","me","mean","means","meantime","meanwhile","merely","mg","might","mightn","mightn't","mill","million","mine","miss","ml","mn","mo","more","moreover","most","mostly","move","mr","mrs","ms","mt","mu","much","mug","must","mustn","mustn't","my","myself","model","n","n2","na","name","namely","nay","nc","nd","ne","near","nearly","necessarily","necessary","need","needn","needn't","needs","neither","never","nevertheless","new","next","ng","ni","nine","ninety","nj","nl","nn","no","nobody","non","none","nonetheless","noone","nor","normally","nos","not","noted","nothing","novel","now","nowhere","nr","ns","nt","ny","o","oa","ob","obtain","obtained","obviously","oc","od","of","off","often","og","oh","oi","oj","ok","okay","ol","old","om","omitted","on","once","one","ones","only","onto","oo","op","oq","or","ord","os","ot","other","others","otherwise","ou","ought","our","ours","ourselves","out","outside","over","overall","ow","owing","own","ox","oz","p","p1","p2","p3","page","pagecount","pages","par","part","particular","particularly","pas","past","pc","pd","pe","per","perhaps","pf","ph","pi","pj","pk","pl","placed","please","plus","pm","pn","po","poorly","possible","possibly","potentially","pp","pq","pr","predominantly","present","presumably","previously","primarily","probably","promptly","proud","provides","ps","pt","pu","put","py","q","qj","qu","que","quickly","quite","qv","r","r2","ra","ran","rather","rc","rd","re","readily","really","reasonably","recent","recently","ref","refs","regarding","regardless","regards","related","relatively","research","research-articl","respectively","resulted","resulting","results","rf","rh","ri","right","rj","rl","rm","rn","ro","rq","rr","rs","rt","ru","run","rv","ry","s","s2","sa","said","same","saw","say","saying","says","sc","sd","se","sec","second","secondly","section","see","seeing","seem","seemed","seeming","seems","seen","self","selves","sensible","sent","serious","seriously","seven","several","sf","shall","shan","shan't","she","shed","she'd","she'll","shes","she's","should","shouldn","shouldn't","should've","show","showed","shown","showns","shows","si","side","significant","significantly","similar","similarly","since","sincere","six","sixty","sj","sl","slightly","sm","sn","so","some","somebody","somehow","someone","somethan","something","sometime","sometimes","somewhat","somewhere","soon","sorry","sp","specifically","specified","specify","specifying","sq","sr","ss","st","still","stop","strongly","sub","substantially","successfully","such","sufficiently","suggest","sup","sure","sy","system","sz","t","t1","t2","t3","take","taken","taking","tb","tc","td","te","tell","ten","tends","tf","th","than","thank","thanks","thanx","that","that'll","thats","that's","that've","the","their","theirs","them","themselves","then","thence","there","thereafter","thereby","thered","therefore","therein","there'll","thereof","therere","theres","there's","thereto","thereupon","there've","these","they","theyd","they'd","they'll","theyre","they're","they've","thickv","thin","think","third","this","thorough","thoroughly","those","thou","though","thoughh","thousand","three","throug","through","throughout","thru","thus","ti","til","tip","tj","tl","tm","tn","to","together","too","took","top","toward","towards","tp","tq","tr","tried","tries","truly","try","trying","ts","t's","tt","tv","twelve","twenty","twice","two","tx","u","u201d","ue","ui","uj","uk","um","un","under","unfortunately","unless","unlike","unlikely","until","unto","uo","up","upon","ups","ur","us","use","used","useful","usefully","usefulness","uses","using","usually","ut","v","va","value","various","vd","ve","ve","very","via","viz","vj","vo","vol","vols","volumtype","vq","vs","vt","vu","w","wa","want","wants","was","wasn","wasnt","wasn't","way","we","wed","we'd","welcome","well","we'll","well-b","went","were","we're","weren","werent","weren't","we've","what","whatever","what'll","whats","what's","when","whence","whenever","when's","where","whereafter","whereas","whereby","wherein","wheres","where's","whereupon","wherever","whether","which","while","whim","whither","who","whod","whoever","whole","who'll","whom","whomever","whos","who's","whose","why","why's","wi","widely","will","willing","wish","with","within","without","wo","won","wonder","wont","won't","words","world","would","wouldn","wouldnt","wouldn't","www","x","x1","x2","x3","xf","xi","xj","xk","xl","xn","xo","xs","xt","xv","xx","y","y2","yes","yet","yj","yl","you","youd","you'd","you'll","your","youre","you're","yours","yourself","yourselves","you've","yr","ys","yt","z","zero","zi","zz","task"]);function tl(i,e){return i.filter(t=>!e.has(t))}function nl(i){let e={};for(let t of i)e[t]=(e[t]||0)+1;return e}function It(i){let e=i.normalize("NFD");return e=e.replace(/\b(a|an|the)\b/g," "),e=e.split(/\s+/).join(" "),e=e.replace(/[!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~]/g,""),e.toLowerCase()}function Gc(i,e){return It(i)===It(e)?1:0}function Uc(i,e){let t=It(i).split(" "),n=It(e).split(" "),r=nl(t),o=nl(n),s=0;for(let c in r){let u=r[c]??0,p=o[c]??0;s+=Math.min(u,p)}if(s===0)return 0;let a=s/t.length,l=s/n.length;return 2*a*l/(a+l)}function Bc(i,e,t,n=!1){let r=It(i).split(" "),o=It(e).split(" "),s=It(t).split(" "),a=new Set([...el,...r]);o=tl(o,a),s=tl(s,a);let l=0,c=l/o.length,u=l/s.length,p=2*c*u/(c+u);return n?u:p}var rl={emScore:Gc,f1Score:Uc,novelF1ScoreOptimized:Bc};var uo=class{ai;program;examples;constructor({ai:e,program:t,examples:n=[]}){if(n.length===0)throw new Error("No examples found");this.ai=e,this.program=t,this.examples=n}async run(e){let t=Date.now(),n=this.examples.length,r=0;for(let s=0;s<n;s++){let a=this.examples[s];if(!a)throw new Error("Invalid example");try{let l=await this.program.forward(this.ai,a,{maxRetries:1}),c=await e({prediction:l,example:a});r+=c}catch(l){console.warn(`Program evaluation failed for example ${s}: ${l instanceof Error?l.message:"Unknown error"}`)}}let o=n>0?r/n:0;this.ai.getOptions().debug&&console.log(`
Performance: `,r,"/",n,"Average Score: ",o,`
`)}};var po=class{rows=[];baseUrl;dataset;split;config;options;constructor({dataset:e,split:t,config:n,options:r}){this.baseUrl="https://datasets-server.huggingface.co/rows",this.dataset=e,this.split=t,this.config=n,this.options=r}async fetchDataFromAPI(e){try{let t=await fetch(e);if(!t.ok)throw new Error(`Error fetching data: ${t.statusText}`);let n=await t.json();if(!n?.rows)throw new Error("Invalid data format");return n.rows}catch(t){throw console.error("Error fetching data from API:",t),t}}async loadData(){let e=this.options?.offset??0,t=this.options?.length??100,n=encodeURIComponent(this.dataset),r=`${this.baseUrl}?dataset=${n}&config=${this.config}&split=${this.split}&offset=${e}&length=${t}`;return this.rows=await this.fetchDataFromAPI(r),this.rows}setData(e){this.rows=e}getData(){return this.rows}async getRows({count:e,fields:t,renameMap:n}){if(this.rows.length===0)throw new Error("No data loaded, call loadData or setData first.");return this.rows.slice(0,e).map(o=>{let s={};return t.forEach(a=>{let l=a.split("."),c=o.row;for(let p of l)Object.hasOwn(c,p)&&(c=c[p]);if(!c)return;let u=n&&a in n?n[a]:a;if(!u)throw new Error(`Invalid field name: ${a}`);s[u]=c}),s}).filter(o=>Object.keys(o).length!==0)}};var ol=i=>{console.log(i)},Us=(i=ol)=>{let e=new Ce,t=e.gray("\u2500".repeat(50)),n=e.gray("\u2501".repeat(50));return r=>{let o="";switch(r.name){case"OptimizationStart":o=`
...
`}i(o)}},sl=(i=ol)=>{let e="\u2500".repeat(60);return t=>{let n="";switch(t.name){case"OptimizationStart":n=`[ OPTIMIZATION START: ${t.value.optimizerType} ]
${e}
...
`);return`${e}
${t}`.trim()}function nu(i){let e=i.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,6),t=cl.default.randomBytes(4).toString("hex");return`${e||"ctx"}-${t}`}function ru(i,e){let t=-1,n;for(let o=0;o<i.length;o+=1){let s=i[o];if(e.has(s.id))continue;let a=s.helpfulCount??0,l=s.harmfulCount??0,c=a-l*2,u=Date.parse(s.updatedAt??s.createdAt),p=[c,a,Number.isFinite(u)?u:Number.POSITIVE_INFINITY];if(!n){t=o,n=p;continue}let d=i[t],m=d.helpfulCount??0,h=d.harmfulCount??0,A=m-h*2,g=Date.parse(d.updatedAt??d.createdAt),f=[A,m,Number.isFinite(g)?g:Number.POSITIVE_INFINITY];(p[0]<f[0]||p[0]===f[0]&&p[1]<f[1]||p[0]===f[0]&&p[1]===f[1]&&p[2]<f[2])&&(t=o,n=p)}if(t===-1)return;let[r]=i.splice(t,1);return r}function Hs(i,e=.95){for(let[t,n]of Object.entries(i.sections)){let r=new Map,o=[];for(let s of n){let a=s.content.trim().toLowerCase(),l=r.get(a);l?(l.helpfulCount+=s.helpfulCount,l.harmfulCount+=s.harmfulCount,l.updatedAt=s.updatedAt):(r.set(a,s),o.push(s))}i.sections[t]=o}Ks(i)}function Ks(i){let e=0,t=0,n=0,r=0;for(let o of Object.values(i.sections))for(let s of o)e+=1,t+=s.helpfulCount,n+=s.harmfulCount,r+=tu(s.content);i.stats={bulletCount:e,helpfulCount:t,harmfulCount:n,tokenEstimate:r}}var ou={maxEpochs:1,maxReflectorRounds:2,maxSectionSize:25,similarityThreshold:.95,allowDynamicSections:!0},Kn=class extends Qe{playbook;artifact;baseInstruction;constructor(e){super({bestScore:e.bestScore,stats:e.stats,instruction:e.instruction,demos:e.demos,examples:e.examples,modelConfig:e.modelConfig,optimizerType:e.optimizerType,optimizationTime:e.optimizationTime,totalRounds:e.totalRounds,converged:e.converged,scoreHistory:e.scoreHistory,configurationHistory:e.configurationHistory}),this.playbook=Tt(e.playbook),this.artifact=e.artifact,this.baseInstruction=e.baseInstruction}applyTo(e){super.applyTo(e);let t=e.getSignature(),r=[(this.baseInstruction??t.getDescription()??"").trim(),"",Hn(this.playbook)].filter(o=>o&&o.trim().length>0).join(`

`);e.setDescription(r)}},ho=class extends Se{aceConfig;playbook;generatorHistory=[];deltaHistory=[];reflectorProgram;curatorProgram;constructor(e,t){super(e),this.aceConfig={...ou,...t},this.playbook=t?.initialPlaybook!==void 0?Tt(t.initialPlaybook):js()}reset(){super.reset(),this.playbook=this.aceConfig.initialPlaybook!==void 0?Tt(this.aceConfig.initialPlaybook):js(),this.generatorHistory=[],this.deltaHistory=[]}configureAuto(e){switch(e){case"light":this.aceConfig.maxEpochs=1,this.aceConfig.maxReflectorRounds=1;break;case"medium":this.aceConfig.maxEpochs=2,this.aceConfig.maxReflectorRounds=2;break;case"heavy":this.aceConfig.maxEpochs=3,this.aceConfig.maxReflectorRounds=3;break}}async compile(e,t,n,r){let o=r?.aceOptions;o&&(Object.assign(this.aceConfig,{maxEpochs:o.maxEpochs??this.aceConfig.maxEpochs,maxReflectorRounds:o.maxReflectorRounds??this.aceConfig.maxReflectorRounds,maxSectionSize:o.maxSectionSize??this.aceConfig.maxSectionSize,similarityThreshold:o.similarityThreshold??this.aceConfig.similarityThreshold,allowDynamicSections:o.allowDynamicSections??this.aceConfig.allowDynamicSections}),o.initialPlaybook&&(this.playbook=Tt(o.initialPlaybook)));let s=Date.now();this.validateExamples(t);let a=await this.extractProgramInstruction(e),l=e.getSignature().getDescription()??"";this.generatorHistory=[],this.deltaHistory=[];let c=Number.NEGATIVE_INFINITY,u=0,p=Math.max(this.aceConfig.maxEpochs,1),d=p*t.length;try{for(let f=0;f<p;f++)for(let x=0;x<t.length;x++){let b=t[x],I=this.composeInstruction(a??l,this.playbook);e.setDescription?.(I);let S=await e.forward(this.studentAI,b);this.stats.totalCalls+=1;let T=await n({prediction:S,example:b});typeof T=="number"&&(this.stats.bestScore=Math.max(this.stats.bestScore,T),c=Math.max(c,T));let w=S?.severity,y=b?.severity,k=this.createGeneratorOutput(S,b),E=y&&w&&y!==w,M=await this.runReflectionRounds({example:b,generatorOutput:k,feedback:y&&w&&y!==w?`Expected severity "${y}" but model predicted "${w}".`:void 0}),R=await this.runCurator({example:b,reflection:M,playbook:this.playbook}),P=this.normalizeCuratorOperations(R?.operations);P.length===0&&E&&(P=this.inferOperationsFromReflection(M)),P=this.resolveCuratorOperationTargets(P,this.playbook,M,k);let C=R||P.length>0?{...R??{},operations:P}:void 0,v=[];if(P.length>0){let ye=this.collectProtectedBulletIds(P),ue=qs(this.playbook,P,{maxSectionSize:this.aceConfig.maxSectionSize,allowDynamicSections:this.aceConfig.allowDynamicSections,enableAutoPrune:!0,protectedBulletIds:ye});v=ue.updatedBulletIds,ue.autoRemoved.length>0&&(P.push(...ue.autoRemoved),C&&(C.operations=P))}if(M?.bulletTags)for(let ye of M.bulletTags)zs(this.playbook,ye.id,ye.tag);P.length>0&&v.length>0&&Hs(this.playbook,this.aceConfig.similarityThreshold);let O={example:b,prediction:S,score:typeof T=="number"?T:0,generatorOutput:k,reflection:M,curator:C,timestamp:new Date().toISOString()};this.generatorHistory.push(O),v.length>0&&C?.operations?.length&&this.deltaHistory.push({epoch:f,exampleIndex:x,operations:C.operations}),u+=1,this.currentRound=u;let $=typeof T=="number"&&Number.isFinite(T)?T:0,Y=Number.isFinite(c)?c:$,W={...r??{},maxIterations:d};await this.updateOptimizationProgress(u,$,{epoch:f,exampleIndex:x,playbookBullets:this.playbook.stats.bulletCount},"ACE",{epochs:p,totalRounds:d},Y,{playbookBullets:this.playbook.stats.bulletCount},void 0,W),this.stats.convergenceInfo.finalImprovement=Math.max(this.stats.convergenceInfo.finalImprovement,$)}}finally{e.setDescription?.(l)}let m=Date.now()-s;this.stats.resourceUsage.totalTime=m,this.stats.convergenceInfo.converged=!0,this.stats.bestScore=Number.isFinite(c)?c:0;let h={playbook:Tt(this.playbook),feedback:[...this.generatorHistory],history:[...this.deltaHistory]},A=new Kn({baseInstruction:a??l,playbook:this.playbook,artifact:h,bestScore:Number.isFinite(c)?c:0,stats:this.stats,optimizerType:"ACE",optimizationTime:m,totalRounds:u,converged:this.stats.convergenceInfo.converged});return{stats:this.stats,bestScore:Number.isFinite(c)?c:0,finalConfiguration:{strategy:"ace",epochs:p},optimizedProgram:A,playbook:Tt(this.playbook),artifact:h}}async applyOnlineUpdate(e){let t=this.createGeneratorOutput(e.prediction,e.example),n=e.prediction?.severity,r=e.example?.severity,o=await this.runReflectionRounds({example:e.example,generatorOutput:t,feedback:e.feedback??(r&&n&&r!==n?`Expected severity "${r}" but model predicted "${n}".`:void 0)}),s=await this.runCurator({example:e.example,reflection:o,playbook:this.playbook}),a=this.normalizeCuratorOperations(s?.operations),l=r&&n&&r!==n;a.length===0&&l&&(a=this.inferOperationsFromReflection(o)),a=this.resolveCuratorOperationTargets(a,this.playbook,o,t);let c=s||a.length>0?{...s??{},operations:a}:void 0;if(o?.bulletTags)for(let p of o.bulletTags)zs(this.playbook,p.id,p.tag);if(a.length>0){let p=this.collectProtectedBulletIds(a),d=qs(this.playbook,a,{maxSectionSize:this.aceConfig.maxSectionSize,allowDynamicSections:this.aceConfig.allowDynamicSections,enableAutoPrune:!0,protectedBulletIds:p});d.autoRemoved.length>0&&(a.push(...d.autoRemoved),c&&(c.operations=a)),Hs(this.playbook,this.aceConfig.similarityThreshold)}let u={example:e.example,prediction:e.prediction,score:0,generatorOutput:t,reflection:o,curator:c,timestamp:new Date().toISOString()};return this.generatorHistory.push(u),c}composeInstruction(e,t){return[e.trim(),"",Hn(t)].filter(r=>r.trim().length>0).join(`

`)}async extractProgramInstruction(e){try{return e.getSignature().getDescription()??void 0}catch{return}}createGeneratorOutput(e,t){let n=e?.thought?.toString()??"",r=Array.isArray(e?.bullet_ids)?e?.bullet_ids:[];return{reasoning:n,answer:e,bulletIds:r,trajectory:JSON.stringify({example:t,prediction:e}),metadata:{predictedSeverity:e?.severity,expectedSeverity:t?.severity}}}resolveCuratorOperationTargets(e,t,n,r){if(!e.length)return e;let o=[],s=new Set(e.map(u=>u.bulletId).filter(u=>typeof u=="string")),a=new Map,l=(u,p)=>{if(s.has(u))return;let d=this.locateBullet(t,u);if(!d)return;let m=a.get(d.section)??{harmful:[],primary:[],generator:[]};m[p].push(d.id),a.set(d.section,m)};for(let u of n?.bulletTags??[]){let p=u.tag==="harmful"?"harmful":"primary";l(u.id,p)}if(r?.bulletIds)for(let u of r.bulletIds)l(u,"generator");let c=u=>{let p=a.get(u);if(!p)return this.locateFallbackBullet(t,u,s);let d=h=>{for(;h.length>0;){let A=h.shift();if(!s.has(A))return A}},m=d(p.harmful)??d(p.primary)??d(p.generator);return m||this.locateFallbackBullet(t,u,s)};for(let u of e){if((u.type==="UPDATE"||u.type==="REMOVE")&&!u.bulletId){let p=c(u.section);p&&(u.bulletId=p,s.add(p))}(u.type==="UPDATE"||u.type==="REMOVE")&&!u.bulletId||o.push(u)}return o}locateBullet(e,t){for(let n of Object.values(e.sections)){let r=n.find(o=>o.id===t);if(r)return r}}locateFallbackBullet(e,t,n){let r=e.sections[t]??[];for(let o of r)if(!n.has(o.id))return o.id}collectProtectedBulletIds(e){let t=new Set;for(let n of e)n.type==="UPDATE"&&n.bulletId&&t.add(n.bulletId);return t}normalizeCuratorOperations(e){if(!e)return[];if(Array.isArray(e)){let t=[],n=new Set;for(let r of e){if(!r||typeof r!="object")continue;let o=r.type??"ADD",s=typeof o=="string"?o.toUpperCase():"ADD",a=s==="UPDATE"?"UPDATE":s==="REMOVE"?"REMOVE":"ADD",l=r.section??"Guidelines",c=typeof l=="string"&&l.trim().length>0?l.trim():"Guidelines",u=r.content??"",p=typeof u=="string"?u.trim():"";if(a!=="REMOVE"&&p.length===0)continue;let d=r.bulletId??r.id,m=typeof d=="string"&&d.trim().length>0?d.trim():void 0,A=[a,c,p,m??""].join(":");if(n.has(A))continue;n.add(A);let g={type:a,section:c};a!=="REMOVE"&&(g.content=p),m&&(g.bulletId=m);let f=r.metadata;f&&typeof f=="object"&&(g.metadata={...f}),t.push(g)}return t}if(typeof e=="string")try{let t=JSON.parse(e);return this.normalizeCuratorOperations(t)}catch{return[]}if(typeof e=="object"){let t=e;if(t&&Array.isArray(t.operations))return this.normalizeCuratorOperations(t.operations);if(t&&typeof t.operations=="string")try{let n=JSON.parse(t.operations);return this.normalizeCuratorOperations(n)}catch{return[]}return[]}return[]}inferOperationsFromReflection(e){if(!e)return[];let t=[],n=new Set,r=(o,s)=>{if(!s)return;let a=s.trim();if(!a||a.toLowerCase().startsWith("no error"))return;let c=`${o}:${a}`;n.has(c)||(n.add(c),t.push({type:"ADD",section:o,content:a}))};return r("Guidelines",e.keyInsight),r("Response Strategies",e.correctApproach),r("Common Pitfalls",e.errorIdentification),r("Root Cause Notes",e.rootCauseAnalysis),t}async runReflectionRounds({example:e,generatorOutput:t,feedback:n}){let r=Math.max(this.aceConfig.maxReflectorRounds,1),o;for(let s=0;s<r;s++){let a=await this.runReflector({example:e,generatorOutput:t,feedback:n,previousReflection:o});if(!a)break;o=a;let l=a.errorIdentification?.toLowerCase().trim()??"";if(a.metadata?.resolved===!0||l.length===0||l.startsWith("no error")||l.startsWith("resolved"))break}return o}async runReflector({example:e,generatorOutput:t,feedback:n,previousReflection:r}){let o=this.getOrCreateReflectorProgram(),s=this.teacherAI??this.studentAI;try{let a={severity:e?.severity,policyHint:e?.policyHint};return await o.forward(s,{question:JSON.stringify(e),generator_answer:JSON.stringify(t.answer),generator_reasoning:t.reasoning,playbook:JSON.stringify({markdown:Hn(this.playbook),structured:this.playbook}),expected_answer:a.severity||a.policyHint?JSON.stringify(a):void 0,feedback:n,previous_reflection:r?JSON.stringify(r):void 0})}catch(a){this.verbose&&console.warn("[AxACE] Reflector error:",a instanceof Error?a.message:a);return}}async runCurator({example:e,reflection:t,playbook:n}){if(!t)return;let r=this.getOrCreateCuratorProgram(),o=this.teacherAI??this.studentAI;try{return await r.forward(o,{playbook:JSON.stringify({markdown:Hn(n),structured:n}),reflection:JSON.stringify(t),question_context:JSON.stringify(e),token_budget:1024})}catch(s){this.verbose&&console.warn("[AxACE] Curator error:",s instanceof Error?s.message:s);return}}getOrCreateReflectorProgram(){if(!this.reflectorProgram){let e=re().input("question",re.string("Original task input serialized as JSON")).input("generator_answer",re.string("Generator output serialized as JSON")).input("generator_reasoning",re.string("Generator reasoning trace").optional()).input("playbook",re.string("Current context playbook rendered as markdown")).input("expected_answer",re.string("Expected output when ground truth is available").optional()).input("feedback",re.string("External feedback or reward signal").optional()).input("previous_reflection",re.string("Most recent reflection JSON when running multi-round refinement").optional()).output("reasoning",re.string("Step-by-step analysis of generator performance")).output("errorIdentification",re.string("Specific mistakes detected")).output("rootCauseAnalysis",re.string("Underlying cause of the error")).output("correctApproach",re.string("What the generator should do differently")).output("keyInsight",re.string("Reusable insight to remember")).output("bulletTags",re.json("Array of {id, tag} entries referencing playbook bullets")).build();this.reflectorProgram=fe(e)}return this.reflectorProgram}getOrCreateCuratorProgram(){if(!this.curatorProgram){let e=re().input("playbook",re.string("Current playbook serialized as JSON")).input("reflection",re.string("Latest reflection output serialized as JSON")).input("question_context",re.string("Original task input serialized as JSON")).input("token_budget",re.number("Approximate token budget for curator response").optional()).output("reasoning",re.string("Justification for the proposed updates")).output("operations",re.json("List of operations with type/section/content fields")).build();this.curatorProgram=fe(e)}return this.curatorProgram}};var rn=class extends Se{maxRounds;maxDemos;maxExamples;batchSize;earlyStoppingPatience;costMonitoring;maxTokensPerGeneration;verboseMode;debugMode;traces=[];constructor(e){super(e);let t=e.options||{};this.maxRounds=t.maxRounds??3,this.maxDemos=t.maxDemos??4,this.maxExamples=t.maxExamples??16,this.batchSize=t.batchSize??1,this.earlyStoppingPatience=t.earlyStoppingPatience??0,this.costMonitoring=t.costMonitoring??!1,this.maxTokensPerGeneration=t.maxTokensPerGeneration??0,this.verboseMode=t.verboseMode??!0,this.debugMode=t.debugMode??!1}async compileRound(e,t,n,r,o){let s=Date.now(),a=o?.maxDemos??this.maxDemos,l={modelConfig:{temperature:.7}};this.maxTokensPerGeneration>0&&(l.modelConfig.max_tokens=this.maxTokensPerGeneration);let c=iu([...t],this.maxExamples),u=this.traces.length;for(let p=0;p<c.length;p+=this.batchSize){p>0&&(l.modelConfig.temperature=.7+.001*p);let d=c.slice(p,p+this.batchSize);for(let m of d){if(!m||typeof m!="object")continue;let h=t.filter(f=>f!==m);e.setExamples(h);let A=this.getTeacherOrStudentAI();this.stats.totalCalls++;let g;try{let f={...l,maxRetries:1};g=await e.forward(A,m,f),this.costMonitoring&&(this.stats.estimatedTokenUsage+=JSON.stringify(m).length/4+JSON.stringify(g).length/4),await r({prediction:g,example:m})>=.5&&(this.traces=[...this.traces,...e.getTraces()],this.stats.successfulDemos++)}catch(f){(this.verboseMode||this.debugMode)&&console.warn(`Student model failed during bootstrap: ${f instanceof Error?f.message:"Unknown error"}`),g={}}if(this.traces.length>=a)return}}if(this.earlyStoppingPatience>0){let d=this.traces.length-u;if(!this.stats.earlyStopping)this.stats.earlyStopping={bestScoreRound:d>0?n:0,patienceExhausted:!1,reason:"No improvement detected"};else if(d>0)this.stats.earlyStopping.bestScoreRound=n;else if(n-this.stats.earlyStopping.bestScoreRound>=this.earlyStoppingPatience){this.stats.earlyStopping.patienceExhausted=!0,this.stats.earlyStopped=!0,this.stats.earlyStopping.reason=`No improvement for ${this.earlyStoppingPatience} rounds`;return}}}async compile(e,t,n,r){this.validateExamples(t,!1);let o=r?.maxIterations??this.maxRounds;this.traces=[],this.reset();for(let l=0;l<o&&(await this.compileRound(e,t,l,n,r),!this.stats.earlyStopped);l++);if(this.traces.length===0)throw new Error("No demonstrations found. Either provide more examples or improve the existing ones.");let s=su(this.traces),a=0;return this.traces.length>0&&(a=this.stats.successfulDemos/Math.max(1,this.stats.totalCalls)),await this.logOptimizationComplete("BootstrapFewShot",a,{maxRounds:this.maxRounds,maxDemos:this.maxDemos,batchSize:this.batchSize,successRate:a,demosGenerated:s.length,tracesCollected:this.traces.length},r),{demos:s,stats:this.stats,bestScore:a,finalConfiguration:{maxRounds:this.maxRounds,maxDemos:this.maxDemos,batchSize:this.batchSize,successRate:a}}}};function su(i){let e=new Map;for(let n of i)if(e.has(n.programId)){let r=e.get(n.programId);r&&r.push(n.trace)}else e.set(n.programId,[n.trace]);let t=[];return e.forEach((n,r)=>{t.push({traces:n,programId:r})}),t}var iu=(i,e)=>{let t=[...i];for(let n=t.length-1;n>0;n--){let r=Math.floor(Math.random()*(n+1)),o=t[n],s=t[r];if(!o||!s)throw new Error("Invalid array elements");[t[n],t[r]]=[s,o]}return t.slice(0,e)};function ul(i,e,t=0){let n=new Set([...Object.keys(i),...Object.keys(e)]),r=!0,o=!1;for(let s of n){let a=i[s]??0,l=e[s]??0;if(a+t<l){r=!1;break}a>l+t&&(o=!0)}return r&&o}function Ye(i,e=0){let t=[];for(let n=0;n<i.length;n++){let r=0,o=!1;for(let s=0;s<i.length;s++)if(n!==s){if(ul(i[s].scores,i[n].scores,e)){o=!0;break}ul(i[n].scores,i[s].scores,e)&&r++}o||t.push({idx:i[n].idx,scores:i[n].scores,dominated:r})}return t}function De(i){if(i.length===0)return;let e=Object.keys(i[0]??{});if(e.length!==2)return;let[t,n]=e,r=[...i].sort((a,l)=>(l[t]??0)-(a[t]??0)),o=0,s=0;for(let a of r){let l=a[t]??0,c=a[n]??0,u=Math.max(c-s,0);o+=l*u,s=Math.max(s,c)}return o}function Ct(i){if(i.length===0)return 0;let e=0;for(let t of i)e+=t;return e/i.length}function fo(i){let e={},t={};for(let r of i)for(let[o,s]of Object.entries(r))e[o]=(e[o]||0)+(typeof s=="number"?s:0),t[o]=(t[o]||0)+1;let n={};for(let[r,o]of Object.entries(e))n[r]=o/Math.max(t[r]||1,1);return n}function Wn(i,e){let t=new Set;for(let u of i)for(let p of u)t.add(p);let r=[...Array.from(t)].sort((u,p)=>(e[u]??0)-(e[p]??0)),o=new Set,s=(u,p)=>{for(let d of i){if(!d.has(u))continue;let m=!1;for(let h of p)if(d.has(h)){m=!0;break}if(!m)return!1}return!0},a=!0;for(;a;){a=!1;for(let u of r){if(o.has(u))continue;let p=new Set(r.filter(d=>d!==u&&!o.has(d)));if(s(u,p)){o.add(u),a=!0;break}}}let l=r.filter(u=>!o.has(u)),c=new Set(l);return i.map(u=>{let p=new Set;for(let d of u)c.has(d)&&p.add(d);return p})}function Vn(i,e,t){let n=Wn(i,e),r={};for(let l of n)for(let c of l)r[c]=(r[c]||0)+1;let o=[];for(let[l,c]of Object.entries(r)){let u=Number(l);for(let p=0;p<c;p++)o.push(u)}if(o.length===0)return 0;let s=typeof t=="function"?t():Math.random(),a=Math.floor(s*o.length);return o[a]}var Ao=class extends Se{numTrials;minibatch;minibatchSize;earlyStoppingTrials;minImprovementThreshold;sampleCount;paretoSetSize;crossoverEvery;tieEpsilon;feedbackMemorySize;feedbackMemory=[];mergeMax;mergesUsed=0;mergesDue=0;totalMergesTested=0;lastIterFoundNewProgram=!1;mergeAttemptKeys=new Set;mergeCompositionKeys=new Set;rngState=123456789;samplerState={epoch:-1,shuffled:[],freq:new Map};localScoreHistory=[];localConfigurationHistory=[];constructor(e){super(e);let t=e?.seed,n=Number.isFinite(t)?Math.floor(Number(t)):0;this.rngState=n&&n!==0?n:123456789,this.numTrials=e.numTrials??30,this.minibatch=e.minibatch??!0,this.minibatchSize=e.minibatchSize??20,this.earlyStoppingTrials=e.earlyStoppingTrials??5,this.minImprovementThreshold=e.minImprovementThreshold??0,this.sampleCount=e.sampleCount??1;let r=e?.paretoSetSize;this.paretoSetSize=r&&r>0?Math.min(1e3,Math.max(5,Math.floor(r))):Math.max(10,Math.min(200,this.minibatchSize*3));let o=e?.crossoverEvery;this.crossoverEvery=Math.max(0,Math.floor(o??Math.max(3,Math.floor(this.numTrials/4))));let s=e?.tieEpsilon;this.tieEpsilon=Number.isFinite(s)?s:0;let a=e?.feedbackMemorySize;this.feedbackMemorySize=Math.max(0,Math.floor(a??4));let l=e?.mergeMax;this.mergeMax=Math.max(0,Math.floor(l??0)),this.mergesUsed=0,this.stats.convergenceInfo.convergenceThreshold=this.minImprovementThreshold}reset(){super.reset(),this.stats.convergenceInfo.convergenceThreshold=this.minImprovementThreshold,this.localScoreHistory=[],this.localConfigurationHistory=[],this.feedbackMemory=[],this.mergesUsed=0,this.mergesDue=0,this.totalMergesTested=0,this.lastIterFoundNewProgram=!1,this.mergeAttemptKeys.clear(),this.mergeCompositionKeys.clear(),this.samplerState.epoch=-1,this.samplerState.shuffled=[],this.samplerState.freq.clear()}async compile(e,t,n,r){let o=Date.now();this.validateExamples(t),r?.auto&&this.configureAuto(r.auto);let s=r?.validationExamples,a=r?.feedbackExamples,l=(s&&s.length>0?s:t).slice(0,this.paretoSetSize),c=a&&a.length>0?a:t,u=async(C,v)=>{try{e.setInstruction?.(C);let O=await e.forward(this.studentAI,v,{sampleCount:this.sampleCount});return this.stats.totalCalls+=1,await n({prediction:O,example:v})||{}}catch{return{}}},p=async(C,v)=>{let O=[];for(let $ of v)O.push(await u(C,$));return fo(O)},d=await this.getBaseInstruction(e),m=[{instruction:d,parent:void 0,scores:await p(d,l)}],h=C=>{let v=r?.paretoMetricKey,O=r?.paretoScalarize;if(typeof O=="function")return O(C);if(v)return Number.isFinite(C[v])?C[v]:0;let $=Object.values(C);return $.length?$.reduce((Y,W)=>Y+W,0)/$.length:0},A=[],g=async(C,v)=>{let O=[];for(let $ of v){let Y=await u(C,$);O.push(h(Y))}return O};A.push(await g(d,l));let f=()=>{let C=A[0]?.length??0,v=[];for(let $=0;$<C;$++){let Y=Number.NEGATIVE_INFINITY,W=new Set;for(let ye=0;ye<A.length;ye++){let ue=A[ye][$];ue>Y+this.tieEpsilon?(Y=ue,W.clear(),W.add(ye)):Math.abs(ue-Y)<=this.tieEpsilon&&W.add(ye)}v.push(W)}let O=A.map($=>Ct($));return Vn(v,O)};this.getOptimizerLogger(r)?.({name:"OptimizationStart",value:{optimizerType:"GEPA",exampleCount:t.length,validationCount:l.length,config:{numTrials:this.numTrials,minibatch:this.minibatch}}});let b=0,I=Ye(m.map((C,v)=>({idx:v,scores:C.scores})),this.tieEpsilon).map(C=>C.idx),S,T=r?.maxMetricCalls;if(!Number.isFinite(T)||T<=0)throw new Error("AxGEPA: options.maxMetricCalls must be set to a positive integer");let w=Math.floor(T);for(let C=0;C<this.numTrials&&!(w!==void 0&&this.stats.totalCalls>=Math.max(1,Math.floor(w)));C++){let v=A[0]?.length??0,O=[];for(let F=0;F<v;F++){let G=Number.NEGATIVE_INFINITY,q=new Set;for(let z=0;z<A.length;z++){let H=A[z][F];H>G+this.tieEpsilon?(G=H,q.clear(),q.add(z)):Math.abs(H-G)<=this.tieEpsilon&&q.add(z)}O.push(q)}let $=A.map(F=>Ct(F));if(this.mergeMax>0&&this.mergesDue>0&&this.lastIterFoundNewProgram){let F=N=>{let _=[],D=N;for(;D!==void 0;)_.push(D),D=m[D]?.parent;return _},G=N=>N.length?N[Math.floor(this.rand()*N.length)]:void 0,q=Wn(O,$),z=new Set;for(let N of q)for(let _ of N)z.add(_);let H=Array.from(z),te;for(let N=0;N<10&&!te&&!(H.length<2);N++){let _=G(H),D=G(H);if(_===D)continue;D<_&&([_,D]=[D,_]);let Z=new Set(F(_)),le=new Set(F(D));if(Z.has(D)||le.has(_))continue;let ee=[...Z].filter(ie=>le.has(ie));if(ee.length===0)continue;let K=ee.map(ie=>Math.max(1e-9,$[ie])),V=this.rand()*K.reduce((ie,Le)=>ie+Le,0),J=ee[ee.length-1];for(let ie=0;ie<ee.length;ie++){if(V<K[ie]){J=ee[ie];break}V-=K[ie]}te={i:_,j:D,a:J}}if(this.lastIterFoundNewProgram=!1,te){let{i:N,j:_,a:D}=te,Z=$[D],le=$[N],ee=$[_],K=m[D].instruction,V=m[N].instruction,J=m[_].instruction,ie=V===K&&J!==V||J===K&&V!==J,Le=Z<=Math.min(le,ee)&&ie,ve="",ke="i",rt=!1;if(Le){let Xe=`${N}|${_}|${D}`;if(this.mergeAttemptKeys.has(Xe))Le=!1;else{V===K&&J!==V?(ve=J,ke="j"):J===K&&V!==J?(ve=V,ke="i"):V!==K&&J!==K&&V!==J?le>ee||le===ee&&this.rand()<.5?(ve=V,ke="i"):(ve=J,ke="j"):(ve=V,ke="i");let se=`${Math.min(N,_)}|${Math.max(N,_)}|${ke}`;if(this.mergeCompositionKeys.has(se))Le=!1;else{this.mergeAttemptKeys.add(Xe),this.mergeCompositionKeys.add(se);let Ge=A[N],Ze=A[_],Oe=Array.from({length:Ge.length},(ne,Ie)=>Ie),ot=Oe.filter(ne=>(Ge[ne]??0)>(Ze[ne]??0)),Rt=Oe.filter(ne=>(Ze[ne]??0)>(Ge[ne]??0)),dt=Oe.filter(ne=>!(ot.includes(ne)||Rt.includes(ne))),et=5,st=Math.ceil(et/3),B=(ne,Ie)=>{if(Ie<=0||ne.length===0)return[];if(ne.length<=Ie)return[...ne];let mn=[],Zn=new Set;for(;mn.length<Ie;){let Ue=Math.floor(this.rand()*ne.length);Zn.has(Ue)||(Zn.add(Ue),mn.push(ne[Ue]))}return mn},oe=[];oe.push(...B(ot,Math.min(st,ot.length))),oe.push(...B(Rt,Math.min(st,Rt.length)));let mt=et-oe.length;oe.push(...B(dt,Math.max(0,mt)));let gt=et-oe.length;if(gt>0){let ne=Oe.filter(Ie=>!oe.includes(Ie));oe.push(...B(ne,Math.min(gt,ne.length)))}let be=oe.slice(0,Math.min(et,Oe.length)),Do=be.map(ne=>l[ne]);rt=!0;let kl=(await g(ve,Do)).reduce((ne,Ie)=>ne+Ie,0),Ol=be.reduce((ne,Ie)=>ne+(Ge[Ie]??0),0),Ml=be.reduce((ne,Ie)=>ne+(Ze[Ie]??0),0);if(kl>=Math.max(Ol,Ml)+this.tieEpsilon){let ne=await p(ve,l);m.push({instruction:ve,parent:D,scores:ne}),A.push(await g(ve,l));let Ie=I.length,mn=De(I.map(Ue=>m[Ue].scores))??0;I=Ye(m.map((Ue,El)=>({idx:El,scores:Ue.scores})),this.tieEpsilon).map(Ue=>Ue.idx);let Zn=De(I.map(Ue=>m[Ue].scores))??0;(I.length>Ie||Zn>mn+1e-6)&&(b=0),this.mergesDue-=1,this.totalMergesTested+=1}}}}if(rt)continue}}let Y=Vn(O,$,()=>this.rand()),W=this.minibatch?this.nextMinibatchIndices(c.length,C).map(F=>c[F]):c;if(r?.skipPerfectScore??!0){let F=Number(r?.perfectScore??1),G=await g(m[Y].instruction,W);if(G.length>0&&G.every(q=>q>=F))continue}let ye=!1,ue=m[Y].instruction,Ae="reflective_mutation",$e,nt;if(ye){let F=(Y+1)%m.length;ue=await this.mergeInstructions(m[Y].instruction,m[F].instruction,r),Ae="merge",this.mergesUsed+=1}else{let F=r?.gepaAdapter;if(F){try{let G={instruction:m[Y].instruction},q=await F.evaluate(W,G,!0);$e=Array.isArray(q?.scores)?q.scores.reduce((N,_)=>N+(Number(_)||0),0):void 0;let z=F.make_reflective_dataset(G,q,["instruction"]),H=await F.propose_new_texts?.(G,z,["instruction"]),te=H?.instruction??(H?Object.values(H)[0]:void 0);typeof te=="string"&&te.length>0?ue=te:ue=await this.reflectInstruction(m[Y].instruction,e,W,async({prediction:N,example:_})=>{let D=await n({prediction:N,example:_}),Z=Object.values(D||{});return Z.length?Z.reduce((le,ee)=>le+ee,0)/Z.length:0},r)}catch{ue=await this.reflectInstruction(m[Y].instruction,e,W,async({prediction:G,example:q})=>{let z=await n({prediction:G,example:q}),H=Object.values(z||{});return H.length?H.reduce((te,N)=>te+N,0)/H.length:0},r)}if($e!==void 0)try{let G=await F.evaluate(W,{instruction:ue},!1);nt=Array.isArray(G?.scores)?G.scores.reduce((q,z)=>q+(Number(z)||0),0):void 0}catch{}}else ue=await this.reflectInstruction(m[Y].instruction,e,W,async({prediction:G,example:q})=>{let z=await n({prediction:G,example:q}),H=Object.values(z||{});return H.length?H.reduce((te,N)=>te+N,0)/H.length:0},r)}let Oo=await g(m[Y].instruction,W),Mo=await g(ue,W),Eo=Oo.reduce((F,G)=>F+G,0),pt=Mo.reduce((F,G)=>F+G,0);if(this.currentRound=C+1,await this.updateOptimizationProgress(this.currentRound,pt,{instructionLen:ue.length,parent:Y,totalRounds:this.numTrials},"GEPA",{strategy:Ae,paretoSetSize:l.length},pt,{instructionLen:m[Y].instruction.length,idx:Y},{...r??{},maxIterations:this.numTrials}),!(pt>Eo+this.tieEpsilon&&($e===void 0||nt===void 0||nt>$e+this.tieEpsilon))){if(++b>=this.earlyStoppingTrials)break;continue}let Po=await p(ue,l);m.push({instruction:ue,parent:Y,scores:Po}),A.push(await g(ue,l));let Fo=I.length,_o=De(I.map(F=>m[F].scores))??0;I=Ye(m.map((F,G)=>({idx:G,scores:F.scores})),this.tieEpsilon).map(F=>F.idx);let No=De(I.map(F=>m[F].scores))??0;if(I.length>Fo||No>_o+1e-6)b=0;else if(b++,b>=this.earlyStoppingTrials)break;this.lastIterFoundNewProgram=!0,this.mergeMax>0&&this.totalMergesTested<this.mergeMax&&(this.mergesDue+=1)}let y=Ye(m.map((C,v)=>({idx:v,scores:C.scores})),this.tieEpsilon),k=y.length>0?Math.max(...y.map(C=>h(C.scores))):0,E;if(y.length>0){let C=Number.NEGATIVE_INFINITY;for(let v of y){let O=h(v.scores);O>C&&(C=O,E=v.idx)}}let M=De(y.map(C=>C.scores));this.stats.convergenceInfo.converged=!0,this.recordParetoMetrics(y.length,m.length,"GEPA",M);let R=Date.now()-o,P=typeof E=="number"?new Qe({bestScore:k,stats:this.stats,instruction:m[E].instruction,demos:[],examples:t,modelConfig:void 0,optimizerType:"GEPA",optimizationTime:R,totalRounds:this.numTrials,converged:this.stats.convergenceInfo.converged}):void 0;return this.generateOptimizationReport(y,M,k),{demos:[],stats:this.stats,bestScore:k,paretoFront:y.map(C=>({demos:[],scores:C.scores,configuration:{candidate:C.idx},dominatedSolutions:C.dominated})),paretoFrontSize:y.length,hypervolume:M,finalConfiguration:{strategy:"gepa",candidates:m.length},optimizedProgram:P}}configureAuto(e){switch(e){case"light":this.numTrials=10,this.minibatch=!0,this.minibatchSize=15;break;case"medium":this.numTrials=20,this.minibatch=!0,this.minibatchSize=25;break;case"heavy":this.numTrials=35,this.minibatch=!0,this.minibatchSize=35;break}}async getBaseInstruction(e){try{let t=e.getSignature?.();if(t&&typeof t.instruction=="string"&&t.instruction.length>0)return t.instruction}catch{}return"Follow the task precisely. Be concise, correct, and consistent."}async evaluateOnSet(e,t,n,r){let o=[];for(let s of n){let a=await this.evaluateOne(e,t,s,r);o.push(a)}return o}async evaluateAvg(e,t,n,r){let o=await this.evaluateOnSet(e,t,n,r);return o.length>0?Ct(o):0}async evaluateOne(e,t,n,r){try{e.setInstruction?.(t);let o=await e.forward(this.studentAI,n,{sampleCount:this.sampleCount});this.stats.totalCalls+=1;let s=await r({prediction:o,example:n});if(typeof s=="number"&&!Number.isNaN(s)){let a=typeof this.targetScore=="number"?this.targetScore:.5;return s>=a&&(this.stats.successfulDemos+=1),s}return 0}catch(o){return this.getLogger()?.({name:"Notification",id:"gepa_eval",value:String(o)}),0}}async reflectInstruction(e,t,n,r,o){let s=[];for(let m of n)try{t.setInstruction?.(e);let h=await t.forward(this.studentAI,m,{sampleCount:this.sampleCount});this.stats.totalCalls+=1;let A=await r({prediction:h,example:m});s.push({input:m,prediction:h,score:typeof A=="number"?A:0})}catch{s.push({input:m,prediction:{},score:0})}let a=o?.overrideTeacherAI??this.teacherAI??this.studentAI,l=fe('minibatch:json "Array of {input,prediction,score}", evalFeedback?:string[] "Evaluator feedback per case if available" -> feedbackSummary:string "Concise feedback: common errors, missing constraints, desired changes"'),c=[],u=o?.feedbackFn;if(typeof u=="function")for(let m=0;m<s.length;m++)try{let h=u({prediction:s[m].prediction,example:s[m].input});h&&(Array.isArray(h)?c.push(...h):c.push(h))}catch{}let p="";try{p=(await l.forward(a,{minibatch:s,evalFeedback:c}))?.feedbackSummary?.trim()||"",p&&(this.feedbackMemory.unshift(p),this.feedbackMemory.length>this.feedbackMemorySize&&this.feedbackMemory.pop())}catch{}let d=fe('currentInstruction:string "Current instruction", feedbackSummary?:string "Summarized feedback", recentFeedback?:string[] "Past feedback memory", minibatch:json "Array of {input,prediction,score}" -> newInstruction:string "Improved instruction within 1-6 sentences."');try{let h=(await d.forward(a,{currentInstruction:e,feedbackSummary:p,recentFeedback:this.feedbackMemory,minibatch:s}))?.newInstruction?.trim();if(h&&h.length>16)return h}catch{}return`${e.trim()} Focus on step-by-step evidence-based reasoning. Avoid hallucinations.`.slice(0,2e3)}updateSamplerShuffled(e){let t=Array.from({length:e},(l,c)=>c);for(let l=t.length-1;l>0;l--){let c=Math.floor(this.rand()*(l+1));[t[l],t[c]]=[t[c],t[l]]}for(let l of t)this.samplerState.freq.set(l,(this.samplerState.freq.get(l)??0)+1);let n=this.minibatchSize,r=e%n,o=r===0?0:n-r,s=Array.from({length:e},(l,c)=>c).sort((l,c)=>(this.samplerState.freq.get(l)??0)-(this.samplerState.freq.get(c)??0)),a=[...t];for(let l=0;l<o;l++){let c=s[l%s.length];a.push(c),this.samplerState.freq.set(c,(this.samplerState.freq.get(c)??0)+1)}this.samplerState.shuffled=a,this.samplerState.epoch+=1}nextMinibatchIndices(e,t){this.samplerState.epoch===-1&&(this.samplerState.epoch=0,this.updateSamplerShuffled(e));let n=this.minibatchSize,r=Math.max(1,Math.floor(this.samplerState.shuffled.length/n)),o=Math.floor(t/r);for(;o>=this.samplerState.epoch;)this.updateSamplerShuffled(e);let s=t*n%this.samplerState.shuffled.length;return this.samplerState.shuffled.slice(s,s+n)}rand(){return this.rngState^=this.rngState<<13,this.rngState^=this.rngState>>>17,this.rngState^=this.rngState<<5,(this.rngState>>>0)/4294967296}generateOptimizationReport(e,t,n){console.log(`
...
`),o+=`${e.white("State:")} ${e.gray(ln(r.state,!0))}
`,o+=n;break}case"StepComplete":{let s=(r.stepType==="execute"||r.stepType==="map"||r.stepType==="merge"||r.stepType==="parallel","\u2705");o=`${e.greenBright(`${s} [ STEP ${r.stepIndex} COMPLETE ]`)} ${e.white(`(${r.stepType})`)}`,r.nodeName&&(o+=` ${e.cyanBright(`Node: ${r.nodeName}`)}`),o+=` ${e.magenta(`in ${cn(r.executionTime)}`)}
...
`,o+=n;break;case"ParallelGroupComplete":o=`${e.blueBright("\u2705 [ PARALLEL GROUP COMPLETE ]")} ${e.white(`Level ${r.groupLevel}`)}`,o+=` ${e.magenta(`in ${cn(r.executionTime)}`)}
...
`,r.state&&(o+=`${e.white("State:")} ${e.gray(ln(r.state,!0))}
`),o+=t;break;default:o=e.gray(JSON.stringify(r,null,2))}i(o)}},dl=(i=pl)=>{let e="=".repeat(80),t="-".repeat(40);return n=>{let r="";switch(n.name){case"FlowStart":r=`
[ AXFLOW START ]
${e}
...
`),r+=`State: ${ln(n.state,!0)}
`,r+=`${t}
`;break;case"StepComplete":r=`[ STEP ${n.stepIndex} COMPLETE ] (${n.stepType})`,n.nodeName&&(r+=` Node: ${n.nodeName}`),r+=` in ${cn(n.executionTime)}
...
`,r+=`${t}
`;break;case"ParallelGroupComplete":r=`[ PARALLEL GROUP COMPLETE ] Level ${n.groupLevel} in ${cn(n.executionTime)}
...
[ AXFLOW COMPLETE ]
${e}
`,r+=`Total Time: ${cn(n.totalExecutionTime)}
`,r+=`Steps Executed: ${n.stepsExecuted}
`,r+=`Output Fields: ${n.outputFields.join(", ")}
`,r+=`Final State: ${ln(n.finalState,!0)}
`,r+=`${e}
